...
# Package managers
npm i -g mongolgpt@latest        # or bun/pnpm/yarn
scoop install mongolgpt             # Windows
choco install mongolgpt             # Windows
brew install sergei10a-rgb/tap/mongolgpt # macOS and Linux (recommended, always up to date)
brew install mongolgpt              # macOS and Linux (official brew formula, updated less)
sudo pacman -S mongolgpt            # Arch Linux (Stable)
paru -S mongolgpt-bin               # Arch Linux (Latest from AUR)
mise use -g mongolgpt               # Any OS
nix run nixpkgs#mongolgpt           # or github:sergei10a-rgb/mongolgpt for latest dev branch
```
...
MongolGPT ডেস্কটপ অ্যাপ্লিকেশন হিসেবেও উপলব্ধ। সরাসরি [রিলিজ পেজ](https://github.com/sergei10a-rgb/mongolgpt/releases) অথবা [mongolgpt.duckdns.org/download](https://mongolgpt.duckdns.org/download) থেকে ডাউনলোড করুন।
...
1. `$MONGOLGPT_INSTALL_DIR` - কাস্টম ইনস্টলেশন ডিরেক্টরি
...
4. `$HOME/.mongolgpt/bin` - ডিফল্ট ফলব্যাক
...
MongolGPT এ দুটি বিল্ট-ইন এজেন্ট রয়েছে যা আপনি `Tab` কি(key) দিয়ে পরিবর্তন করতে পারবেন।
...
এজেন্টদের সম্পর্কে আরও জানুন: [docs](https://mongolgpt.duckdns.org/docs/agents)।

### ডকুমেন্টেশন (Documentation)

কিভাবে MongolGPT কনফিগার করবেন সে সম্পর্কে আরও তথ্যের জন্য, [**আমাদের ডকস দেখুন**](https://mongolgpt.duckdns.org/docs)।

### অবদান (Contributing)

আপনি যদি MongolGPT এ অবদান রাখতে চান, অনুগ্রহ করে একটি পুল রিকোয়েস্ট সাবমিট করার আগে আমাদের [কন্ট্রিবিউটিং ডকস](./CONTRIBUTING.md) পড়ে নিন।

### MongolGPT এর উপর বিল্ডিং (Building on MongolGPT)

আপনি যদি এমন প্রজেক্টে কাজ করেন যা MongolGPT এর সাথে সম্পর্কিত এবং প্রজেক্টের নামের অংশ হিসেবে "mongolgpt" ব্যবহার করেন, উদাহরণস্বরূপ "mongolgpt-dashboard" বা "mongolgpt-mobile", তবে দয়া করে আপনার README তে একটি নোট যোগ করে স্পষ্ট করুন যে এই প্রজেক্টটি MongolGPT দল দ্বারা তৈরি হয়নি এবং আমাদের সাথে এর কোনো সরাসরি সম্পর্ক নেই।

---

**আমাদের কমিউনিটিতে যুক্ত হোন** [Discord](https://discord.gg/mongolgpt) | [X.com](https://x.com/mongolgpt)
