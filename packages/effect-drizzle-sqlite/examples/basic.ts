...
class Database extends Context.Service<Database, DatabaseShape>()("@mongolgpt/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@mongolgpt/example/UserStore") {
