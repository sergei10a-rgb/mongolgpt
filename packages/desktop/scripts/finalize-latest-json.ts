...
const releaseId = process.env.MONGOLGPT_RELEASE
if (!releaseId) throw new Error("MONGOLGPT_RELEASE is required")
...
const macxTarGz = "mongolgpt-desktop-mac-x64.app.tar.gz"
const macaTarGz = "mongolgpt-desktop-mac-arm64.app.tar.gz"
