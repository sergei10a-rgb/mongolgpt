...
const mongolgptBackground = {
  light: resolveThemeVariant(mongolgptTheme.light, false)["background-base"],
  dark: resolveThemeVariant(mongolgptTheme.dark, true)["background-base"],
}
...
function defaultBackgroundColor() {
  return mongolgptBackground[tone()]
}
