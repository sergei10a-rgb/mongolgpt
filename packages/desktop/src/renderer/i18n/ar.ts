export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من MongolGPT",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من MongolGPT، هل ترغب في تثبيته وإعادة تشغيله؟",
