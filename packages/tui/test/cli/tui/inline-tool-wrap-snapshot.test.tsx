...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "MONGOLGPT.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/mongolgpt/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/mongolgpt (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/mongolgpt/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/mongolgpt/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const MONGOLGPT_DB|MONGOLGPT_DB|MONGOLGPT_DEV|Global\\.Path\\.data|data =" in packages/mongolgpt/src (115 matches)',
  },
] as const
