...
export function DialogExportOptions(props: DialogExportOptionsProps) {
  ...
  return (
    <box paddingLeft={2} paddingRight={2} gap={1}>
      ...
      <box gap={1}>
        <box>
          <text fg={theme.text}>Файлын нэр:</text>
        </box>
        <textarea
          onSubmit={() => {
            props.onConfirm?.({
          ...
          placeholder="Файлын нэр оруулах"
      ...
      <box flexDirection="column">
        ...
        >
          ...
          <text fg={store.active === "thinking" ? theme.primary : theme.text}>Бодолтыг оруулах</text>
        </box>
        <box
          flexDirection="row"
          gap={2}
        ...
        >
          ...
          <text fg={store.active === "toolDetails" ? theme.primary : theme.text}>Хэрэгслийн дэлгэрэнгүйг оруулах</text>
        </box>
        <box
          flexDirection="row"
          gap={2}
        ...
        >
          ...
          <text fg={store.active === "openWithoutSaving" ? theme.primary : theme.text}>Хадгалахгүй нээх</text>
        </box>
      </box>
