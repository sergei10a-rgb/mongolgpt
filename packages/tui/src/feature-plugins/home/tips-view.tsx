...
const TIPS: Tip[] = [
  ...
  "{highlight}/connect{/highlight} ажиллуулж 75+ дэмжигдсэн LLM үйлчилгээ үзүүлэгчийн API key нэмнэ",
  ...
  "Бүрхүүлийн гаралт оруулахдаа команд дотор backtick ашиглана (жишээ: {highlight}`git status`{/highlight})",
  ...
  "Сешн дуусахад OS мэдэгдэл илгээхийн тулд залгаас ашиглана",
  ...
  "Өнгөний сэдэв нь dark/light хоёр горимын хувилбар дэмждэг",
  "Өөрийн өнгөний сэдвийн JSON дотор 0-255 numeric xterm color code ашиглана",
  "Тохиргоо дотор орчны хувьсагч заахдаа {highlight}{env:VAR_NAME}{/highlight} syntax ашиглана",
