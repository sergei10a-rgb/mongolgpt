    ...
    commands: [
      {
        ...
        title: "Өмнөх товчны бүлэг",
        desc: "Өмнөх which-key бүлгийг харуулах",
        category: "Систем",
        run() {
          moveGroup(-1)
        },
      },
      {
        ...
        title: "Дараагийн товчны бүлэг",
        desc: "Дараагийн which-key бүлгийг харуулах",
        category: "Систем",
        run() {
          moveGroup(1)
        },
      },
      {
        ...
        title: "Товчны жагсаалтыг дээш гүйлгэх",
        desc: "Which-key самбарыг дээш гүйлгэх",
        category: "Систем",
        run() {
          scroll(-columns())
        },
      },
      {
        ...
        title: "Товчны жагсаалтыг доош гүйлгэх",
        desc: "Which-key самбарыг доош гүйлгэх",
        category: "Систем",
        run() {
          scroll(columns())
        },
      ...
      {
        name: command.pageUp,
        title: "Товчны жагсаалтыг нэг хуудсаар дээш гүйлгэх",
        desc: "Which-key самбарыг нэг хуудсаар дээш гүйлгэх",
        category: "Систем",
        run() {
          scroll(-pageSize())
        },
      },
      {
        ...
        title: "Товчны жагсаалтыг нэг хуудсаар доош гүйлгэх",
        desc: "Which-key самбарыг нэг хуудсаар доош гүйлгэх",
        category: "Систем",
        run() {
          scroll(pageSize())
        },
          ...
          <box width="100%" flexDirection="row" justifyContent="space-between" flexShrink={0}>
            <box>
              <text fg={look().text} wrapMode="none">
                асаах/унтраах <span style={{ fg: look().subtle }}>{trigger() || command.toggle}</span>
              </text>
            </box>
            <box>
              <text fg={look().text} wrapMode="none">
