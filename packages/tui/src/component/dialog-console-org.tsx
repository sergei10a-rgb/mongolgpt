...
import type { ExperimentalConsoleListOrgsResponse } from "@mongolgpt/sdk/v2"
...
export function DialogConsoleOrg() {
  ...
  const options = createMemo(() => {
    ...
    if (listed === undefined) {
      return [
        {
          title: "Байгууллагуудыг ачаалж байна...",
          value: "loading",
          onSelect: () => {},
        },
      ]
    ...
    return listed
      ...
      .map((item) => ({
        ...
        onSelect: async () => {
          ...
          toast.show({
            message: `${item.orgName} руу шилжлээ`,
            variant: "info",
          })
          dialog.clear()
        },
        ...
        showError() ? (
          <box paddingLeft={4} paddingRight={4}>
            <text fg={theme.error} attributes={TextAttributes.BOLD}>
              Байгууллагуудыг ачаалж чадсангүй
            </text>
