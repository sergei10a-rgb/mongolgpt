  ...
  const options = createMemo(() => {
    ...
    return entries
      .map((entry, index) => {
        ...
        return {
          title: isDeleting ? `Баталгаажуулахын тулд ${deleteHint()} дахин дарна уу` : getStashPreview(entry.input),
          bg: isDeleting ? theme.error : undefined,
          value: index,
          description: getRelativeTime(entry.timestamp),
          footer: lineCount > 1 ? `~${lineCount} мөр` : undefined,
        }
      })
      .toReversed()
  })
