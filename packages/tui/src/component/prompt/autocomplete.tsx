...
import { useBindings, useCommandSlashes, useMongolGPTModeStack } from "../../keymap"
import { displayCharAt, mentionTriggerIndex } from "../../prompt/display"
import type { FileSystemEntry } from "@mongolgpt/sdk/v2"
        ...
        <Index
          ...
          fallback={
            <box paddingLeft={1} paddingRight={1}>
              <text fg={theme.textMuted}>Тохирох зүйл алга</text>
            </box>
          }
        >
          {(option, index) => (
