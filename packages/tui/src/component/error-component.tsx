...
export function ErrorComponent(props: { error: Error; reset: () => void; mode?: "dark" | "light" }) {
  ...
  // Safe fallback palette per mode (mirrors theme/assets/mongolgpt.json) since the
  ...
  const actions = [
    { key: "c", label: () => (copied() ? "✓ Хууллаа" : "Тайлан хуулах"), copy: true, onUse: copyReport },
    { key: "r", label: () => "Дахин эхлүүлэх", onUse: props.reset },
    { key: "q", label: () => "Гарах", onUse: () => exit() },
  ]
