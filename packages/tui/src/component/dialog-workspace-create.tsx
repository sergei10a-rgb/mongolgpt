import type { ExperimentalWorkspaceAdapterListResponse, Workspace } from "@mongolgpt/sdk/v2"
  ...
  const options = createMemo<DialogSelectOption<WorkspaceSelectValue>[]>(() => {
    ...
    return [
      ...
      ...(hasMore
        ? [
            {
              title: "Бүх ажлын орчинг харах",
              value: { type: "existing-list" as const },
              description: "Бүх ажлын орчноос сонгох",
              category: "Ажлын орчин сонгох",
            },
          ]
        : []),
