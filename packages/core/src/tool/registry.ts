...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@mongolgpt/llm"
...
export class Service extends Context.Service<Service, Interface>()("@mongolgpt/v2/ToolRegistry") {}
