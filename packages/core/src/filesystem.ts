...
import { Entry, FileSystem, FindInput, Match } from "@mongolgpt/schema/filesystem"
export { Entry, Match, Submatch } from "@mongolgpt/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@mongolgpt/v2/FileSystem") {}
