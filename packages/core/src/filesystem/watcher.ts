...
import { FileSystemWatcher } from "@mongolgpt/schema/filesystem-watcher"
...
declare const MONGOLGPT_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof MONGOLGPT_LIBC === "undefined" ? undefined : MONGOLGPT_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@mongolgpt/v2/FileWatcher") {}

export const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.MONGOLGPT_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (yield* Flag.MONGOLGPT_EXPERIMENTAL_FILEWATCHER) {
