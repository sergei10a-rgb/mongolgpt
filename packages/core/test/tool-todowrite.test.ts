...
import { SessionTodo } from "@mongolgpt/core/session/todo"
import { TodoWriteTool } from "@mongolgpt/core/tool/todowrite"
  ...
  it.effect("does not update persisted todos when permission is denied", () =>
    Effect.gen(function* () {
      ...
      expect(
        ...
        type: "error",
        value: "Хийх ажлын жагсаалтыг шинэчилж чадсангүй",
      })
