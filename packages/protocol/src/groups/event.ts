...
import type { Definition } from "@mongolgpt/schema/event"
...
export const MongolGPTEvent = event.schema
export type MongolGPTEvent = typeof MongolGPTEvent.Type
export type MongolGPTEventEncoded = typeof MongolGPTEvent.Encoded
