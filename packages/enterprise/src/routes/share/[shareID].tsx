import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@mongolgpt/sdk/v2"
import { SessionTurn } from "@mongolgpt/session-ui/session-turn"
import { SessionReview } from "@mongolgpt/session-ui/session-review"
import { DataProvider } from "@mongolgpt/session-ui/context"
import { FileComponentProvider } from "@mongolgpt/ui/context/file"
import { WorkerPoolProvider } from "@mongolgpt/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@mongolgpt/ui/logo"
import { IconButton } from "@mongolgpt/ui/icon-button"
import { ProviderIcon } from "@mongolgpt/ui/provider-icon"
import { iife } from "@mongolgpt/core/util/iife"
import { Binary } from "@mongolgpt/core/util/binary"
import { NamedError } from "@mongolgpt/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@mongolgpt/ui/tabs"
import { MessageNav } from "@mongolgpt/session-ui/message-nav"
import { FileSSR } from "@mongolgpt/session-ui/file-ssr"
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/mongolgpt-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              <IconButton
                                as={"a"}
                                href="https://github.com/sergei10a-rgb/mongolgpt"
                                target="_blank"
                                icon="github"
                                variant="ghost"
                              />
