...
import { LLM, LLMClient, Message, ProviderID, Tool, ToolRuntime } from "@mongolgpt/llm"
import { Route, Auth, Endpoint, Framing, Protocol, RequestExecutor, WebSocketExecutor } from "@mongolgpt/llm/route"
...
const rawOverlayExample = LLM.request({
  ...
  http: {
    ...
    headers: { "x-mongolgpt-tutorial": "1" },
    query: { debug: "1" },
  },
})
