...
describe("hosted console legacy route contract", () => {
  ...
  test("keeps retired Zen marketing and OpenCode media out of active console surfaces", async () => {
    ...
    expect(home).toContain('<h1>MongolGPT</h1>')
    expect(home).toContain('data-component="pillar-band"')
    expect(home).toContain('data-component="experience-band"')
    expect(home).toContain('data-component="account-band"')
    expect(home).toContain('data-component="launch-band"')
    expect(home).toContain('language.route("/pricing")')
    expect(home).toContain('language.route("/download")')
    expect(home).toContain('language.route("/docs")')
