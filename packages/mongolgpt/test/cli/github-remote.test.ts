...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/mongolgpt.git")).toEqual({ owner: "sst", repo: "mongolgpt" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/mongolgpt")).toEqual({ owner: "sst", repo: "mongolgpt" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/mongolgpt.git")).toEqual({ owner: "sst", repo: "mongolgpt" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/mongolgpt")).toEqual({ owner: "sst", repo: "mongolgpt" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/mongolgpt.git")).toEqual({ owner: "sst", repo: "mongolgpt" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/mongolgpt")).toEqual({ owner: "sst", repo: "mongolgpt" })
})
