...
describe("tui thread", () => {
  ...
  cliIt.live("rejects mini-only options without --mini", ({ mongolgpt }) =>
    Effect.gen(function* () {
  ...
  cliIt.live("routes attached sessions to mini mode", ({ mongolgpt }) =>
    Effect.gen(function* () {
  ...
  cliIt.live("rejects network options in mini mode", ({ mongolgpt }) =>
    Effect.gen(function* () {
