...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips mongolgpt-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-mongolgpt-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-mongolgpt-directory")).toBeNull()
      expect(result.get("x-mongolgpt-workspace")).toBeNull()
