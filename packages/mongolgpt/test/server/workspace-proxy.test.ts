...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips mongolgpt-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-mongolgpt-directory"]).toBeUndefined()
      expect(forwarded["x-mongolgpt-workspace"]).toBeUndefined()
