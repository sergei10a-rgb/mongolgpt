...
//     await using tmp = await tmpdir({
//       init: async (dir) => {
//         await Bun.write(path.join(dir, "mongolgpt.json"), JSON.stringify({ $schema: "https://raw.githubusercontent.com/sergei10a-rgb/mongolgpt/main/packages/web/public/config.json" }))
//       },
//     })
//     await withTestInstance({
//       directory: tmp.path,
