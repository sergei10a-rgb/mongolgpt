...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders MONGOLGPT_CALLER", () => {
    process.env["MONGOLGPT_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode MONGOLGPT_CALLER", () => {
    process.env["MONGOLGPT_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown MONGOLGPT_CALLER", () => {
    process.env["MONGOLGPT_CALLER"] = "unknown"
