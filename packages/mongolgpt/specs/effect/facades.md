...
Concrete inventory of the remaining `makeRuntime(...)`-backed facades in `packages/mongolgpt`.
...
- [x] `../core/src/filesystem.ts` (`FileSystem`) - legacy mongolgpt service removed
