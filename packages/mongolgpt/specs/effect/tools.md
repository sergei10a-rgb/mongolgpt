...
Practical reference for the current tool-migration state in `packages/mongolgpt`.
...
Tool tests should use the existing Effect helpers in `packages/mongolgpt/test/lib/effect.ts`:
