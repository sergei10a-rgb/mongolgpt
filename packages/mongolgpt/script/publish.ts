...
if (!Script.preview) {
  ...
  const binaryPkgbuild = [
    ...
    "depends=('ripgrep')",
    "",
    `source_aarch64=("\${pkgname}_\${pkgver}_aarch64.tar.gz::https://github.com/sergei10a-rgb/mongolgpt/releases/download/v\${pkgver}\${_subver}/mongolgpt-linux-arm64.tar.gz")`,
    `sha256sums_aarch64=('${arm64Sha}')`,

    `source_x86_64=("\${pkgname}_\${pkgver}_x86_64.tar.gz::https://github.com/sergei10a-rgb/mongolgpt/releases/download/v\${pkgver}\${_subver}/mongolgpt-linux-x64.tar.gz")`,
  ...
  const homebrewFormula = [
    ...
    `      url "https://github.com/sergei10a-rgb/mongolgpt/releases/download/v${Script.version}/mongolgpt-darwin-x64.zip"`,
    `      sha256 "${macX64Sha}"`,
    "",
    "      def install",
    ...
    "    end",
    "    if Hardware::CPU.arm?",
    `      url "https://github.com/sergei10a-rgb/mongolgpt/releases/download/v${Script.version}/mongolgpt-darwin-arm64.zip"`,
    `      sha256 "${macArm64Sha}"`,
    "",
    "      def install",
    '        bin.install "mongolgpt"',
    ...
    `      url "https://github.com/sergei10a-rgb/mongolgpt/releases/download/v${Script.version}/mongolgpt-linux-x64.tar.gz"`,
    `      sha256 "${x64Sha}"`,
    "      def install",
    '        bin.install "mongolgpt"',
    "      end",
    ...
    `      url "https://github.com/sergei10a-rgb/mongolgpt/releases/download/v${Script.version}/mongolgpt-linux-arm64.tar.gz"`,
    `      sha256 "${arm64Sha}"`,
    "      def install",
    '        bin.install "mongolgpt"',
    "      end",
