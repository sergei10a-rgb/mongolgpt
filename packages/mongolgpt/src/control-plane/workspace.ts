...
import { WorkspaceEvent } from "@mongolgpt/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@mongolgpt/Workspace") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        MONGOLGPT_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        MONGOLGPT_WORKSPACE_ID: config.id,
        MONGOLGPT_EXPERIMENTAL_WORKSPACES: "true",
