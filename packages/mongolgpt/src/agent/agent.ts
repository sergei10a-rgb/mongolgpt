...
import { AbsolutePath, type DeepMutable } from "@mongolgpt/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@mongolgpt/Agent") {}
          ...
          plan: {
            ...
            permission: Permission.merge(
              ...
              Permission.fromConfig({
                ...
                edit: {
                  "*": "deny",
                  [path.join(".mongolgpt", "plans", "*.md")]: "allow",
                  [path.join(".mongolgpt", "plans", "*.md")]: "allow",
