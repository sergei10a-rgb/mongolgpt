...
import { Slug } from "@mongolgpt/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@mongolgpt/llm"
...
import { PartTable, SessionTable } from "@mongolgpt/core/session/sql"
...
import { NonNegativeInt, optional } from "@mongolgpt/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".mongolgpt", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@mongolgpt/Session") {}
