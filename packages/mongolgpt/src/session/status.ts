...
import { SessionStatusEvent } from "@mongolgpt/schema/session-status-event"
...
export class Service extends Context.Service<Service, Interface>()("@mongolgpt/SessionStatus") {}
