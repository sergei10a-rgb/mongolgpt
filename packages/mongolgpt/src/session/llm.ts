...
import { llmClient } from "@mongolgpt/core/effect/layer-node-platform"
...
import type { LLMEvent } from "@mongolgpt/llm"
import { LLMClient, RequestExecutor, WebSocketExecutor } from "@mongolgpt/llm/route"
import type { LLMClientService } from "@mongolgpt/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@mongolgpt/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // from the workflow service are executed via MongolGPT's tool system
      ...
      // Runtime seam: native is an opt-in adapter over @mongolgpt/llm. It
