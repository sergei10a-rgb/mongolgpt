import type { JsonSchema, LLMRequest, ProviderMetadata } from "@mongolgpt/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@mongolgpt/llm"
import { AmazonBedrock, Anthropic, Azure, Google, OpenAI, OpenAICompatible, OpenRouter } from "@mongolgpt/llm/providers"
...
export const request = (input: RequestInput) => {
  ...
  // @mongolgpt/llm request objects from MongolGPT's session/AI SDK-shaped data.
  return LLM.request({
