import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@mongolgpt/llm"
...
// Move this extraction into @mongolgpt/llm when Copilot is handled by the native runtime.
