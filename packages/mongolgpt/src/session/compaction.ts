...
import { buildPrompt } from "@mongolgpt/core/session/compaction"
import { SessionCompactionEvent } from "@mongolgpt/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@mongolgpt/SessionCompaction") {}
