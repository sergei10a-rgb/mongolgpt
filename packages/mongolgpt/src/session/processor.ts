...
import { Usage, type LLMEvent } from "@mongolgpt/llm"
...
export class Service extends Context.Service<Service, Interface>()("@mongolgpt/SessionProcessor") {}
        ...
        switch (value.type) {
          ...
          case "tool-input-start":
            if (ctx.assistantMessage.summary) {
              throw new Error(`Summary үүсгэж байх үед tool call хийхийг зөвшөөрөхгүй: ${value.name}`)
            }
