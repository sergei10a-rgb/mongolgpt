...
import { MAX_STEPS_PROMPT } from "@mongolgpt/core/session/runner/max-steps"
...
import { LLMEvent } from "@mongolgpt/llm"
...
export class Service extends Context.Service<Service, Interface>()("@mongolgpt/SessionPrompt") {}
