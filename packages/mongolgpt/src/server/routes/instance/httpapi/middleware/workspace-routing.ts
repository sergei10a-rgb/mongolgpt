...
>()("@mongolgpt/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@mongolgpt/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.MONGOLGPT_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.MONGOLGPT_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-mongolgpt-directory"] || process.cwd()
}
