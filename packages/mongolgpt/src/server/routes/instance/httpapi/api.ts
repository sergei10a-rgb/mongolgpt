...
import { SkillV2 } from "@mongolgpt/core/skill"
...
import { makeApi } from "@mongolgpt/protocol/api"
import { LocationMiddleware } from "@mongolgpt/server/location"
import { SessionLocationMiddleware } from "@mongolgpt/server/middleware/session-location"
...
export const RootHttpApi = HttpApi.make("mongolgpt-root")
...
export const MongolGPTHttpApi = HttpApi.make("mongolgpt")
