...
export const WebCommand = effectCmd({
  ...
  handler: Effect.fn("Cli.web")(function* (args) {
    ...
    if (opts.hostname === "0.0.0.0") {
      ...
      UI.println(UI.Style.TEXT_INFO_BOLD + "  Локал хандалт:     ", UI.Style.TEXT_NORMAL, localhostUrl)
      ...
      if (networkIPs.length > 0) {
        for (const ip of networkIPs) {
          UI.println(
            UI.Style.TEXT_INFO_BOLD + "  Сүлжээний хандалт: ",
      ...
      UI.println(UI.Style.TEXT_INFO_BOLD + "  Web интерфэйс:    ", UI.Style.TEXT_NORMAL, displayUrl)
