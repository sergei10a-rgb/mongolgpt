...
export const StatsCommand = effectCmd({
  ...
  builder: (yargs) =>
    yargs
      .option("days", {
        describe: "сүүлийн N өдрийн статистик харуулах (анхдагч: бүх хугацаа)",
        type: "number",
      })
      .option("tools", {
...
const aggregateSessionStats = Effect.fn("Cli.stats.aggregate")(function* (
  ...
  if (filteredSessions.length > 1000) {
    console.log(`Их хэмжээний өгөгдөл илэрлээ (${filteredSessions.length} сешн). Түр хугацаа шаардаж магадгүй...`)
  }
...
export function displayStats(stats: SessionStats, toolLimit?: number, modelLimit?: number) {
  ...
  console.log("│                       ЕРӨНХИЙ                         │")
  console.log("├────────────────────────────────────────────────────────┤")
  console.log(renderRow("Сешн", stats.totalSessions.toLocaleString()))
  console.log(renderRow("Мессеж", stats.totalMessages.toLocaleString()))
  console.log(renderRow("Өдөр", stats.days.toString()))
  console.log("└────────────────────────────────────────────────────────┘")
  console.log()
