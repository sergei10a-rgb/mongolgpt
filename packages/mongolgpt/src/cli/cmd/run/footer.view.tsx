...
import { createColors, createFrames } from "@mongolgpt/tui/ui/spinner"
import {
...
export function RunFooterView(props: RunFooterViewProps) {
  ...
  const statusText = createMemo(() => {
    if (exiting()) {
      return `Гарахын тулд ${clearShortcut() || "ctrl+c"} дахин дарна уу`
    }

    if (busy()) {
      return armed() ? "таслахын тулд дахин дарна уу" : "таслах"
    }
