...
export function RejectField(props: {
  ...
  return (
    <textarea
      ...
      maxHeight={3}
      wrapMode="word"
      placeholder="MongolGPT-д өөрөөр юу хийхийг хэлнэ үү"
...
export function RunPermissionBody(props: {
  ...
  const title = createMemo(() => {
    if (state().stage === "always") {
      return "Үргэлж зөвшөөрөх"
    }

    if (state().stage === "reject") {
      return "Зөвшөөрлөөс татгалзах"
    }
      ...
      >
        ...
        <Switch>
          ...
          <Match when={state().stage === "reject"}>
            <box paddingLeft={1}>
              <text fg={props.theme.muted}>MongolGPT-д юуг өөрөөр хийхийг хэлнэ үү</text>
            </box>
          </Match>
        </Switch>
      </box>
              ...
              <Show
                ...
                fallback={
                  <text fg={props.theme.muted} wrapMode="word" flexShrink={0}>
                    Зөвшөөрлийн event хүлээж байна...
                  </text>
                }
              >
                <box flexDirection="row" gap={2} flexShrink={0}>
                  <text fg={props.theme.text}>
                    enter <span style={{ fg: props.theme.muted }}>батлах</span>
                  </text>
                  <text fg={props.theme.text}>
              ...
              >
                <box width="100%" flexDirection="column" gap={1}>
                  ...
                  <Show when={!info().diff && info().lines.length === 0}>
                    <box paddingLeft={1}>
                      <text fg={props.theme.muted}>Diff ирээгүй байна</text>
                    </box>
                  </Show>
                </box>
              </scrollbox>
        ...
        >
          ...
          >
            <box flexDirection="row" gap={2} flexShrink={0}>
              ...
              <text fg={props.theme.text}>
                esc <span style={{ fg: props.theme.muted }}>{state().stage === "always" ? "цуцлах" : "татгалзах"}</span>
              </text>
            </box>
          </Show>
        </box>
