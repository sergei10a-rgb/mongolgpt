...
//
// The saved variant persists across sessions in ~/.local/state/mongolgpt/model.json
...
class Service extends Context.Service<Service, VariantService>()("@mongolgpt/RunVariant") {}
