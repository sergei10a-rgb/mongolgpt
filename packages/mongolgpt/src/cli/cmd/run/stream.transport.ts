...
import type { Event, GlobalEvent, MongolGPTClient } from "@mongolgpt/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@mongolgpt/RunStreamTransport") {}
