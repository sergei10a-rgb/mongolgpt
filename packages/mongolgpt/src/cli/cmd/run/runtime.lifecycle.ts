...
import { openEditor } from "@mongolgpt/tui/editor"
import { registerMongolGPTKeymap } from "@mongolgpt/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerMongolGPTKeymap(keymap, renderer, input.tuiConfig)
