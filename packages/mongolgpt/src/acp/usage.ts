...
import type { AssistantMessage as MongolGPTAssistantMessage, Message } from "@mongolgpt/sdk/v2"
...
export type AssistantTokenCost = Pick<MongolGPTAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<MongolGPTAssistantMessage, "role"> &
  Partial<Pick<MongolGPTAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@mongolgpt/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@mongolgpt/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@mongolgpt/ACPUsage") {}
