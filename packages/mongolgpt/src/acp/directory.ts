...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@mongolgpt/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@mongolgpt/ACPDirectory") {}
