...
import type * as SDK from "@mongolgpt/sdk/v2"
...
import { SessionShareTable } from "@mongolgpt/core/share/sql"
...
export class Service extends Context.Service<Service, Interface>()("@mongolgpt/ShareNext") {}
