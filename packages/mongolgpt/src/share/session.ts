...
export class Service extends Context.Service<Service, Interface>()("@mongolgpt/SessionShare") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const share = Effect.fn("SessionShare.share")(function* (sessionID: SessionID) {
      ...
      if (conf.share === "disabled") throw new Error("Тохиргоонд сесс хуваалцахыг идэвхгүй болгосон байна")
