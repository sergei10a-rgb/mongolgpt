      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Browser дээр DigitalOcean-д нэвтэрнэ үү. MongolGPT таны DigitalOcean API token-ийг inference-д шууд ашиглаж, Inference Router-уудыг ачаална. Router-уудыг шинэчлэх бол /connect-г дахин ажиллуулна уу.",
