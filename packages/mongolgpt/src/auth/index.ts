...
export const OAUTH_DUMMY_KEY = "mongolgpt-oauth-dummy-key"
...
export class Service extends Context.Service<Service, Interface>()("@mongolgpt/Auth") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const all = Effect.fn("Auth.all")(function* () {
      const authContent = process.env.MONGOLGPT_AUTH_CONTENT
      if (authContent) {
        try {
