...
export class Service extends Context.Service<Service, Interface>()("@mongolgpt/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __MONGOLGPT_PHOTON_WASM_PATH?: string }).__MONGOLGPT_PHOTON_WASM_PATH =
