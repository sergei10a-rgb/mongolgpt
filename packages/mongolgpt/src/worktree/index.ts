...
import { path } from "@mongolgpt/core/effect/layer-node-platform"
...
import type { ProjectV2 } from "@mongolgpt/core/project"
...
import { WorktreeEvent } from "@mongolgpt/schema/worktree-event"
...
export class Service extends Context.Service<Service, Interface>()("@mongolgpt/Worktree") {}
  ...
  Effect.gen(function* () {
    ...
    const candidate = Effect.fn("Worktree.candidate")(function* (input: {
      ...
      for (const attempt of Array.from({ length: MAX_NAME_ATTEMPTS }, (_, i) => i)) {
        ...
        const branch = input.detached ? undefined : `mongolgpt/${name}`
