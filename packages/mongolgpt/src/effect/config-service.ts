 ...
 *   "@mongolgpt/ServerAuthConfig",
 *   {
 *     password: Config.string("MONGOLGPT_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("MONGOLGPT_SERVER_USERNAME").pipe(Config.withDefault("mongolgpt")),
 *   },
 * ) {}
 *
