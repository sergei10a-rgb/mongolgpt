...
import { McpEvent } from "@mongolgpt/schema/mcp-event"

const DEFAULT_TIMEOUT = 30_000
const CLIENT_OPTIONS = {
  capabilities: {
    // https://github.com/sergei10a-rgb/mongolgpt/issues/11948
    // sampling: {},
    // https://github.com/sergei10a-rgb/mongolgpt/issues/23066
    // elicitation: {},
    // https://github.com/sergei10a-rgb/mongolgpt/issues/2308
    roots: {},
    // https://github.com/sergei10a-rgb/mongolgpt/issues/28567
    // tasks: {},
  },
...
function createClient(directory: string) {
  const client = new Client({ name: "mongolgpt", version: InstallationVersion }, CLIENT_OPTIONS)
...
export class Service extends Context.Service<Service, Interface>()("@mongolgpt/MCP") {}
