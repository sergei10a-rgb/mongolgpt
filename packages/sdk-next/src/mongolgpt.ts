import { MongolGPT } from "@mongolgpt/client/effect"
...
import { createEmbeddedRoutes } from "@mongolgpt/server/routes"
import { Context, Effect, Layer, Scope } from "effect"
import { FetchHttpClient, HttpRouter, HttpServer } from "effect/unstable/http"

export const create = Effect.fn("MongolGPT.create")(function* () {
  ...
  const client = yield* MongolGPT.make({ baseUrl: "http://mongolgpt.local" }).pipe(
...
export class Service extends Context.Service<Service, Interface>()("@mongolgpt/sdk-next/MongolGPT") {}
