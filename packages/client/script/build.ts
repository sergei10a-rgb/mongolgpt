...
import { compile, emitEffectImported, emitPromise, write } from "@mongolgpt/httpapi-codegen"
    ...
    [
      write(
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              name: "MongolGPTEventEncoded",
              import: 'import type { MongolGPTEventEncoded } from "@mongolgpt/protocol/groups/event"',
            },
          },
        }),
