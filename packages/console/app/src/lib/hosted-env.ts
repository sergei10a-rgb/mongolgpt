import { hostedPreviewConfig } from "./hosted-preview"
...
export const hostedPreviewEnabled = import.meta.env.VITE_MONGOLGPT_PREVIEW_ENABLED === "true"
export const hostedPreview = hostedPreviewConfig({
