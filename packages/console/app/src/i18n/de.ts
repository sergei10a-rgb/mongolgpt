...
export const dict = {
  ...
  "temp.title": "MongolGPT | Für das Terminal gebauter AI-Coding-Agent",
  ...
  "temp.feature.zen.afterLink": "bereitgestellt von MongolGPT",
  ...
  "temp.screenshot.caption": "MongolGPT TUI mit dem Tokyonight-Theme",
  "temp.screenshot.alt": "MongolGPT TUI mit Tokyonight-Theme",
  "temp.logoLightAlt": "MongolGPT Logo hell",
  "temp.logoDarkAlt": "MongolGPT Logo dunkel",
  ...
  "home.faq.a3.p3":
    "Während wir dazu raten, Zen zu nutzen, funktioniert MongolGPT auch mit allen beliebten Anbietern wie OpenAI, Anthropic, xAI etc.",
  ...
  "home.faq.a6":
    "MongolGPT ist zu 100% kostenlos. Es enthält auch eine Reihe kostenloser Modelle. Zusätzliche Kosten können entstehen, wenn du andere Anbieter verbindest.",
  ...
  "home.zenCta.body":
    "Zen gibt dir Zugriff auf ein handverlesenes Set an AI-Modellen, die MongolGPT speziell für Coding-Agents getestet und bewertet hat. Keine Sorge wegen inkonsistenter Leistung und Qualität bei verschiedenen Anbietern – nutze validierte Modelle, die funktionieren.",
  "home.zenCta.link": "Erfahre mehr über Zen",

  "zen.title": "MongolGPT Zen | Ein kuratiertes Set zuverlässiger, optimierter Modelle für Coding-Agents",
  "zen.hero.title": "Zuverlässige, optimierte Modelle für Coding-Agents",
  "zen.hero.body":
    "Zen gibt dir Zugriff auf ein kuratiertes Set an AI-Modellen, die MongolGPT speziell für Coding-Agents getestet und bewertet hat. Keine Sorge wegen inkonsistenter Leistung und Qualität – nutze validierte Modelle, die funktionieren.",

  "zen.faq.q1": "Was ist MongolGPT Zen?",
  "zen.faq.a1":
    "Zen ist ein kuratiertes Set an AI-Modellen, getestet und bewertet für Coding-Agents, erstellt vom Team hinter MongolGPT.",
  ...
  "zen.faq.a3":
    "Zen ist nicht gewinnorientiert. Zen gibt die Kosten der Modellanbieter an dich weiter. Je höher die Nutzung von Zen, desto besser kann MongolGPT Preise verhandeln und diese an dich weitergeben.",
  ...
  "zen.faq.a4.p3":
    "Um die Kosten zu decken, fügt MongolGPT nur eine kleine Bearbeitungsgebühr von $1.23 pro $20 Guthabenaufladung hinzu.",
  ...
  "zen.faq.a8":
    "Während Zen großartig mit MongolGPT funktioniert, kannst du Zen mit jedem Agent nutzen. Folge den Einrichtungsanweisungen in deinem bevorzugten Coding-Agent.",
  ...
  "zen.problem.subtitle": "Wir beheben das für alle, nicht nur für MongolGPT-Nutzer.",
  ...
  "zen.how.body": "Während wir dir raten, Zen mit MongolGPT zu nutzen, kannst du Zen mit jedem Agent nutzen.",
  ...
  "go.title": "MongolGPT Go | Kostengünstige Coding-Modelle für alle",
  ...
  "go.problem.body":
    "Wir konzentrieren uns darauf, die MongolGPT-Erfahrung so vielen Menschen wie möglich zugänglich zu machen. MongolGPT Go ist ein kostengünstiges Abonnement: $5 im ersten Monat, danach $10/Monat. Es bietet großzügige Limits und zuverlässigen Zugang zu den leistungsfähigsten Open-Source-Modellen.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body":
    "Go beginnt bei $5 für den ersten Monat, danach $10/Monat. Du kannst es mit MongolGPT oder jedem Agenten nutzen.",
  ...
  "go.faq.q1": "Was ist MongolGPT Go?",
  "go.faq.a1":
  ...
  "zen.api.error.trialEnded":
    "Die kostenlose Aktion für {{model}} ist beendet. Du kannst das Modell weiterhin nutzen, indem du MongolGPT Go abonnierst - {{link}}",

  "black.meta.title": "MongolGPT Black | Zugriff auf die weltweit besten Coding-Modelle",
  "black.meta.description": "Erhalte Zugriff auf Claude, GPT, Gemini und mehr mit MongolGPT Black Abos.",
  ...
  "black.title": "MongolGPT Black | Preise",
  ...
  "black.workspace.title": "MongolGPT Black | Workspace wählen",
  "black.workspace.selectPlan": "Wähle einen Workspace für diesen Plan",
  "black.workspace.name": "Workspace {{n}}",
  "black.subscribe.title": "MongolGPT Black abonnieren",
  ...
  "black.subscribe.success.title": "Du bist auf der MongolGPT Black Warteliste",
  ...
  "workspace.newUser.feature.lockin.body":
    "Nutze Zen mit jedem Coding-Agent und nutze weiterhin andere Anbieter mit MongolGPT, wann immer du willst.",
  ...
  "workspace.black.subscription.message": "Du hast MongolGPT Black für ${{plan}} pro Monat abonniert.",
  ...
  "workspace.black.waitlist.joined": "Du bist auf der Warteliste für den ${{plan}} pro Monat MongolGPT Black Plan.",
  "workspace.black.waitlist.ready":
    "Wir sind bereit, dich in den ${{plan}} pro Monat MongolGPT Black Plan aufzunehmen.",
  ...
  "workspace.lite.subscription.message": "Du hast MongolGPT Go abonniert.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Wähle "MongolGPT Go" als Anbieter in deiner mongolgpt-Konfiguration, um Go-Modelle zu verwenden.',
  "workspace.lite.black.message":
    "Du hast derzeit MongolGPT Black abonniert oder stehst auf der Warteliste. Bitte kündige zuerst, wenn du zu Go wechseln möchtest.",
  "workspace.lite.other.message":
    "Ein anderes Mitglied in diesem Workspace hat MongolGPT Go bereits abonniert. Nur ein Mitglied pro Workspace kann abonnieren.",
  "workspace.lite.promo.description":
    "MongolGPT Go startet bei {{price}}, danach $10/Monat, und bietet zuverlässigen Zugang zu beliebten offenen Coding-Modellen mit großzügigen Nutzungslimits.",
  ...
  "download.faq.a3.afterZen":
    " zu nutzen, funktioniert MongolGPT mit allen populären Anbietern wie OpenAI, Anthropic, xAI etc.",

  "download.faq.a5.p1": "MongolGPT ist 100% kostenlos.",
  "download.faq.a5.p2.beforeZen":
    "Zusätzliche Kosten entstehen durch dein Abo bei einem Modellanbieter. Während MongolGPT mit jedem Modellanbieter funktioniert, empfehlen wir",
