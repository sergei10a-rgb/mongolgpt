...
export const dict = {
  ...
  "temp.title": "MongolGPT | Agent de code IA conçu pour le terminal",
  ...
  "temp.feature.zen.afterLink": "fournie par MongolGPT",
  ...
  "temp.screenshot.caption": "MongolGPT TUI avec le thème tokyonight",
  "temp.screenshot.alt": "MongolGPT TUI avec le thème tokyonight",
  ...
  "home.faq.a3.p3":
    "Nous encourageons l'utilisation de Zen, mais MongolGPT fonctionne aussi avec les fournisseurs populaires comme OpenAI, Anthropic, xAI, etc.",
  ...
  "home.faq.a6":
    "MongolGPT est 100% gratuit. Il inclut aussi des modèles gratuits. Des coûts supplémentaires peuvent s'appliquer si vous connectez un autre fournisseur.",
  ...
  "home.zenCta.body":
    "Zen vous donne accès à un ensemble sélectionné de modèles d'IA que MongolGPT a testés et benchmarkés spécifiquement pour les agents de code. Plus besoin de vous soucier des variations de performance et de qualité selon les fournisseurs : utilisez des modèles validés qui fonctionnent.",
  "home.zenCta.link": "En savoir plus sur Zen",

  "zen.title": "MongolGPT Zen | Un ensemble sélectionné de modèles fiables et optimisés pour les agents de code",
  "zen.hero.title": "Modèles fiables et optimisés pour les agents de code",
  "zen.hero.body":
    "Zen vous donne accès à un ensemble sélectionné de modèles d'IA que MongolGPT a testés et benchmarkés spécifiquement pour les agents de code. Plus besoin de vous soucier des variations de performance et de qualité selon les fournisseurs : utilisez des modèles validés qui fonctionnent.",

  "zen.faq.q1": "Qu'est-ce que MongolGPT Zen ?",
  "zen.faq.a1":
    "Zen est un ensemble sélectionné de modèles d'IA testés et benchmarkés pour les agents de code, créé par l'équipe derrière MongolGPT.",
  ...
  "zen.faq.a3":
    "Zen n'est pas à but lucratif. Zen vous facture au prix coûtant des fournisseurs de modèles. Plus Zen est utilisé, plus MongolGPT peut négocier de meilleurs tarifs et vous les répercuter.",
  ...
  "zen.faq.a4.p3":
    "Pour couvrir les coûts, MongolGPT ajoute uniquement de petits frais de traitement de paiement de 1,23 $ par recharge de 20 $.",
  ...
  "zen.faq.a8":
    "Zen fonctionne très bien avec MongolGPT, mais vous pouvez utiliser Zen avec n'importe quel agent. Suivez les instructions de configuration dans votre agent préféré.",
  ...
  "zen.problem.subtitle":
    "Nous résolvons ce problème pour tout le monde, pas seulement pour les utilisateurs de MongolGPT.",
  ...
  "zen.how.body":
    "Bien que nous vous suggérions d'utiliser Zen avec MongolGPT, vous pouvez utiliser Zen avec n'importe quel agent.",
  ...
  "go.title": "MongolGPT Go | Modèles de code à faible coût pour tous",
  ...
  "go.problem.body":
    "Nous nous efforçons d'apporter l'expérience MongolGPT au plus grand nombre. MongolGPT Go est un abonnement à faible coût : $5 pour le premier mois, puis 10 $/mois. Il offre des limites généreuses et un accès fiable aux modèles open source les plus performants.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body":
    "Go commence à $5 pour le premier mois, puis 10 $/mois. Vous pouvez l'utiliser avec MongolGPT ou n'importe quel agent.",
  ...
  "go.faq.q1": "Qu'est-ce que MongolGPT Go ?",
  "go.faq.a1":
  ...
  "zen.api.error.trialEnded":
    "La promotion gratuite de {{model}} est terminée. Vous pouvez continuer à utiliser le modèle en vous abonnant à MongolGPT Go - {{link}}",

  "black.meta.title": "MongolGPT Black | Accédez aux meilleurs modèles de code au monde",
  "black.meta.description": "Accédez à Claude, GPT, Gemini et plus avec les forfaits d'abonnement MongolGPT Black.",
  "black.hero.title": "Accédez aux meilleurs modèles de code au monde",
  "black.hero.subtitle": "Y compris Claude, GPT, Gemini et plus",
  "black.title": "MongolGPT Black | Tarification",
  ...
  "black.workspace.title": "MongolGPT Black | Sélectionner un espace de travail",
  "black.workspace.selectPlan": "Sélectionnez un espace de travail pour ce forfait",
  "black.workspace.name": "Espace de travail {{n}}",
  "black.subscribe.title": "S'abonner à MongolGPT Black",
  ...
  "black.subscribe.success.title": "Vous êtes sur la liste d'attente MongolGPT Black",
  ...
  "workspace.newUser.feature.lockin.body":
    "Utilisez Zen avec n'importe quel agent de code et continuez à utiliser d'autres fournisseurs avec MongolGPT quand vous le souhaitez.",
  ...
  "workspace.black.subscription.message": "Vous êtes abonné à MongolGPT Black pour {{plan}} $ par mois.",
  ...
  "workspace.black.waitlist.joined":
    "Vous êtes sur la liste d'attente pour le forfait MongolGPT Black à {{plan}} $ par mois.",
  "workspace.black.waitlist.ready":
    "Nous sommes prêts à vous inscrire au forfait MongolGPT Black à {{plan}} $ par mois.",
  ...
  "workspace.lite.subscription.message": "Vous êtes abonné à MongolGPT Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Sélectionnez "MongolGPT Go" comme fournisseur dans votre configuration mongolgpt pour utiliser les modèles Go.',
  "workspace.lite.black.message":
    "Vous êtes actuellement abonné à MongolGPT Black ou sur liste d'attente. Veuillez d'abord vous désabonner si vous souhaitez passer à Go.",
  "workspace.lite.other.message":
    "Un autre membre de cet espace de travail est déjà abonné à MongolGPT Go. Un seul membre par espace de travail peut s'abonner.",
  "workspace.lite.promo.description":
    "MongolGPT Go commence à {{price}}, puis 10 $/mois, et offre un accès fiable aux modèles de code ouverts populaires avec des limites d'utilisation généreuses.",
  ...
  "download.faq.a3.afterZen":
    ", MongolGPT fonctionne avec tous les fournisseurs populaires comme OpenAI, Anthropic, xAI, etc.",

  "download.faq.a5.p1": "MongolGPT est 100% gratuit à utiliser.",
  "download.faq.a5.p2.beforeZen":
    "Les coûts supplémentaires viendront de votre abonnement à un fournisseur de modèle. Même si MongolGPT fonctionne avec n'importe quel fournisseur, nous recommandons d'utiliser",
