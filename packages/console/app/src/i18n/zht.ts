...
export const dict = {
  ...
  "home.faq.a3.p1": "不一定。登入 MongolGPT 帳號後即可免費使用 Free Auto。",
  ...
  "gateway.api.error.rateLimitExceeded": "超出頻率限制。請稍後再試。",
  "gateway.api.error.modelNotSupported": "不支援模型 {{model}}",
  "gateway.api.error.modelFormatNotSupported": "模型 {{model}} 不支援格式 {{format}}",
  "gateway.api.error.noProviderAvailable": "無可用的供應商",
  "gateway.api.error.providerNotSupported": "不支援供應商 {{provider}}",
  "gateway.api.error.missingApiKey": "缺少 API 金鑰。",
  "gateway.api.error.invalidApiKey": "無效的 API 金鑰。",
  "gateway.api.error.subscriptionQuotaExceeded": "超出訂閱配額。請在 {{retryIn}} 後重試。",
  "gateway.api.error.noPaymentMethod": "無付款方式。請在此處新增付款方式：{{billingUrl}}",
  "gateway.api.error.insufficientBalance": "餘額不足。請在此處管理你的帳務：{{billingUrl}}",
  "gateway.api.error.workspaceMonthlyLimitReached":
    "你的工作區已達到每月支出限額 ${{amount}}。請在此處管理你的限額：{{billingUrl}}",
  "gateway.api.error.userMonthlyLimitReached": "你已達到每月支出限額 ${{amount}}。請在此處管理你的限額：{{membersUrl}}",
  "gateway.api.error.modelDisabled": "模型已停用",
