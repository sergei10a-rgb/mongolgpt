...
export const dict = {
  ...
  "temp.title": "MongolGPT | 專為終端打造的 AI 編碼代理",
  ...
  "temp.feature.zen.afterLink": "由 MongolGPT 提供",
  "temp.feature.models.beforeLink": "透過",
  "temp.feature.models.afterLink": "支援 75+ 家 LLM 供應商，包括本地模型",
  "temp.screenshot.caption": "使用 tokyonight 主題的 MongolGPT TUI",
  "temp.screenshot.alt": "使用 tokyonight 主題的 MongolGPT TUI",
  "temp.logoLightAlt": "mongolgpt 淺色標誌",
  "temp.logoDarkAlt": "mongolgpt 深色標誌",
  ...
  "home.faq.a3.p3": "我們鼓勵使用 Zen，但 MongolGPT 也支援 OpenAI、Anthropic、xAI 等主流供應商。",
  ...
  "home.faq.a6": "MongolGPT 100% 免費使用。它也自帶一組免費模型。如果你連接其他供應商，可能會產生額外費用。",
  ...
  "home.zenCta.body":
    "Zen 提供一組精選的 AI 模型，這些模型是 MongolGPT 為了編碼代理專門測試與評測過的。無需擔心不同供應商之間效能與品質參差不齊，使用經過驗證的模型即可。",
  "home.zenCta.link": "了解 Zen",

  "zen.title": "MongolGPT Zen | 專為編碼代理精選的可靠最佳化模型",
  "zen.hero.title": "專為編碼代理提供的可靠最佳化模型",
  "zen.hero.body":
    "Zen 提供一組精選的 AI 模型，這些模型是 MongolGPT 為了編碼代理專門測試與評測過的。無需擔心效能與品質參差不齊，使用經過驗證的模型即可。",

  "zen.faq.q1": "什麼是 MongolGPT Zen？",
  "zen.faq.a1": "Zen 是由 MongolGPT 團隊打造、專為編碼代理測試與評測的 AI 模型精選集合。",
  "zen.faq.q2": "是什麼讓 Zen 更準確？",
  "zen.faq.a2": "Zen 只提供專為編碼代理測試與評測的模型。你不會用奶油刀切牛排，也別用糟糕的模型來寫程式。",
  "zen.faq.q3": "Zen 更便宜嗎？",
  "zen.faq.a3":
    "Zen 不以營利為目的。Zen 會把模型供應商的成本原樣轉給你。Zen 的使用量越高，MongolGPT 就越能談到更好的價格並把優惠讓利給你。",
  ...
  "zen.faq.a4.p3": "為了覆蓋成本，MongolGPT 只會收取很小的支付處理費：每次儲值 $20 會額外收取 $1.23。",
  "zen.faq.q5": "資料與隱私如何？",
  ...
  "zen.faq.a8":
    "Zen 與 MongolGPT 搭配得很好，但你也可以在任何代理中使用 Zen。請在你偏好的編碼代理中按照設定說明進行配置。",
  ...
  "zen.problem.subtitle": "我們正在為所有人解決此問題，而不僅僅是 MongolGPT 使用者。",
  ...
  "zen.how.body": "雖然我們建議你將 Zen 與 MongolGPT 一起使用，但你可以將 Zen 與任何代理一起使用。",
  ...
  "go.title": "MongolGPT Go | 低成本全民編碼模型",
  ...
  "go.problem.body":
    "我們致力於將 MongolGPT 體驗帶給盡可能多的人。MongolGPT Go 是一款低成本訂閱服務：首月 $5，之後 $10/月。它提供充裕的額度，並讓您能可靠地使用最強大的開源模型。",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go 起價為首月 $5，之後 $10/月。您可以將其與 MongolGPT 或任何代理搭配使用。",
  ...
  "zen.api.error.trialEnded": "{{model}} 的限免活动已結束。您可以訂閱 MongolGPT Go 繼續使用該模型 - {{link}}",

  "black.meta.title": "MongolGPT Black | 存取全球最佳編碼模型",
  "black.meta.description": "透過 MongolGPT Black 訂閱方案存取 Claude、GPT、Gemini 等模型。",
  "black.hero.title": "存取全球最佳編碼模型",
  "black.hero.subtitle": "包括 Claude、GPT、Gemini 等",
  "black.title": "MongolGPT Black | 定價",
  ...
  "black.workspace.title": "MongolGPT Black | 選擇工作區",
  "black.workspace.selectPlan": "為此方案選擇一個工作區",
  "black.workspace.name": "工作區 {{n}}",
  "black.subscribe.title": "訂閱 MongolGPT Black",
  ...
  "black.subscribe.success.title": "你已在 MongolGPT Black 候補名單上",
  ...
  "workspace.newUser.feature.lockin.body":
    "將 Zen 與任何編碼代理結合使用，並在需要時隨時使用 MongolGPT 連接其他供應商。",
  ...
  "workspace.black.subscription.message": "你已訂閱 MongolGPT Black，費用為每月 ${{plan}}。",
  ...
  "workspace.black.waitlist.joined": "你已加入每月 ${{plan}} 的 MongolGPT Black 方案候補名單。",
  "workspace.black.waitlist.ready": "我們已準備好將你加入每月 ${{plan}} 的 MongolGPT Black 方案。",
  ...
  "workspace.lite.subscription.message": "您已訂閱 MongolGPT Go。",
  ...
  "workspace.lite.subscription.selectProvider":
    "在您的 mongolgpt 設定中選擇「MongolGPT Go」作為提供商，即可使用 Go 模型。",
  "workspace.lite.black.message": "您目前已訂閱 MongolGPT Black 或在候補名單中。若要切換至 Go，請先取消訂閱。",
  "workspace.lite.other.message": "此工作區中的另一位成員已訂閱 MongolGPT Go。每個工作區只能有一位成員訂閱。",
  "workspace.lite.promo.description":
    "MongolGPT Go 起價為 {{price}}，之後 $10/月，並提供對熱門開放編碼模型的可靠存取，同時享有充裕的使用額度。",
  ...
  "download.faq.a3.afterZen": "，但 MongolGPT 同樣支援 OpenAI、Anthropic、xAI 等所有主流供應商。",

  "download.faq.a5.p1": "MongolGPT 100% 免費使用。",
  "download.faq.a5.p2.beforeZen": "額外費用來自你對模型供應商的訂閱。雖然 MongolGPT 支援任何模型供應商，但我們建議使用",
