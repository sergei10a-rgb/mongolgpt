...
export const dict = {
  ...
  "black.meta.title": "MongolGPT Black | Få adgang til verdens bedste kodningsmodeller",
  "black.meta.description": "Få adgang til Claude, GPT, Gemini og mere med MongolGPT Black-abonnementer.",
  ...
  "black.workspace.title": "MongolGPT Black | Vælg workspace",
  ...
  "black.subscribe.success.title": "Du er på MongolGPT Black-ventelisten",
  ...
  "workspace.black.subscription.message": "Du abonnerer på MongolGPT Black for ${{plan}} om måneden.",
  ...
  "workspace.black.waitlist.joined": "Du er på ventelisten for ${{plan}} per måned MongolGPT Black plan.",
  "workspace.black.waitlist.ready": "Vi er klar til at tilmelde dig ${{plan}} per måned MongolGPT Black plan.",
  ...
  "workspace.lite.black.message":
    "Du abonnerer i øjeblikket på MongolGPT Black eller er på venteliste. Afmeld venligst først, hvis du vil skifte til Go.",
