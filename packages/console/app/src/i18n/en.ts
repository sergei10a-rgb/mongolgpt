export const dict = {
  ...
  "black.meta.title": "MongolGPT Black | Access all the world's best coding models",
  "black.meta.description": "Get access to Claude, GPT, Gemini and more with MongolGPT Black subscription plans.",
  "black.hero.title": "Access all the world's best coding models",
  "black.hero.subtitle": "Including Claude, GPT, Gemini and more",
  "black.title": "MongolGPT Black | Pricing",
  ...
  "black.workspace.title": "MongolGPT Black | Select Workspace",
  "black.workspace.selectPlan": "Select a workspace for this plan",
  "black.workspace.name": "Workspace {{n}}",
  "black.subscribe.title": "Subscribe to MongolGPT Black",
  ...
  "black.subscribe.success.title": "You're on the MongolGPT Black waitlist",
  ...
  "workspace.black.subscription.message": "You are subscribed to MongolGPT Black for ${{plan}} per month.",
  ...
  "workspace.black.waitlist.joined": "You are on the waitlist for the ${{plan}} per month MongolGPT Black plan.",
  "workspace.black.waitlist.ready": "We're ready to enroll you into the ${{plan}} per month MongolGPT Black plan.",
  ...
  "workspace.lite.black.message":
    "You're currently subscribed to MongolGPT Black or on the waitlist. Please unsubscribe first if you'd like to switch to Go.",
