export const dict = {
  ...
  "temp.feature.zen.afterLink": "provided by mongolgpt",
  "temp.feature.models.beforeLink": "Supports 75+ LLM providers through",
  "temp.feature.models.afterLink": ", including local models",
  "temp.screenshot.caption": "mongolgpt TUI with the tokyonight theme",
  "temp.screenshot.alt": "mongolgpt TUI with tokyonight theme",
  ...
  "home.faq.a3.p1":
    "Not necessarily, MongolGPT comes with a set of free models that you can use without creating an account.",
  ...
  "home.faq.a3.p3":
    "While we encourage users to use Zen, MongolGPT also works with all popular providers such as OpenAI, Anthropic, xAI etc.",
  ...
  "home.faq.a6":
    "MongolGPT is 100% free to use. It also comes with a set of free models. There might be additional costs if you connect any other provider.",
  ...
  "home.zenCta.body":
    "Zen gives you access to a handpicked set of AI models that MongolGPT has tested and benchmarked specifically for coding agents. No need to worry about inconsistent performance and quality across providers, use validated models that work.",
  "home.zenCta.link": "Learn about Zen",

  "zen.title": "MongolGPT Zen | A curated set of reliable optimized models for coding agents",
  "zen.hero.title": "Reliable optimized models for coding agents",
  "zen.hero.body":
    "Zen gives you access to a curated set of AI models that MongolGPT has tested and benchmarked specifically for coding agents. No need to worry about inconsistent performance and quality, use validated models that work.",

  "zen.faq.q1": "What is MongolGPT Zen?",
  "zen.faq.a1":
    "Zen is a curated set of AI models tested and benchmarked for coding agents created by the team behind MongolGPT.",
  ...
  "zen.faq.a3":
    "Zen is not for profit. Zen passes through the costs from the model providers to you. The higher Zen's usage the more MongolGPT can negotiate better rates and pass those to you.",
  ...
  "zen.faq.a4.p3":
    "To cover costs, MongolGPT adds only a small payment processing fee of $1.23 per $20 balance top-up.",
  ...
  "zen.faq.a8":
    "While Zen works great with MongolGPT, you can use Zen with any agent. Follow the setup instructions in your preferred coding agent.",
  ...
  "zen.problem.subtitle": "We're fixing this for everyone, not just MongolGPT users.",
  ...
  "zen.how.body": "While we suggest you use Zen with MongolGPT, you can use Zen with any agent.",
  ...
  "go.title": "MongolGPT Go | Low cost coding models for everyone",
  ...
  "go.problem.body":
    "We're focused on bringing the MongolGPT experience to as many people as possible. MongolGPT Go is a low cost subscription: $5 for your first month, then $10/month. It provides generous limits and reliable access to the most capable open source models.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go starts at $5 for your first month, then $10/month. You can use it with MongolGPT or any agent.",
  ...
  "go.faq.q1": "What is MongolGPT Go?",
  "go.faq.a1":
  ...
  "zen.api.error.trialEnded":
    "Free promotion has ended for {{model}}. You can continue using the model by subscribing to MongolGPT Go - {{link}}",
  ...
  "workspace.newUser.feature.lockin.body":
    "Use Zen with any coding agent, and continue using other providers with mongolgpt whenever you want.",
  ...
  "workspace.lite.subscription.message": "You are subscribed to MongolGPT Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Select "MongolGPT Go" as the provider in your mongolgpt configuration to use Go models.',

  "workspace.lite.other.message":
    "Another member in this workspace is already subscribed to MongolGPT Go. Only one member per workspace can subscribe.",
  "workspace.lite.promo.description":
    "MongolGPT Go starts at {{price}}, then $10/month, and provides reliable access to popular open coding models with generous usage limits.",
  ...
  "download.faq.a3.afterZen": ", MongolGPT works with all popular providers such as OpenAI, Anthropic, xAI etc.",

  "download.faq.a5.p1": "MongolGPT is 100% free to use.",
  "download.faq.a5.p2.beforeZen":
    "Any additional costs will come from your subscription to a model provider. While MongolGPT works with any model provider, we recommend using",
