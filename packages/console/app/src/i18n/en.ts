export const dict = {
  ...
  "gateway.api.error.rateLimitExceeded": "Rate limit exceeded. Please try again later.",
  "gateway.api.error.freeAutoWeeklyLimitExceeded": "Free Auto weekly token limit reached. Retry in {{retryIn}}.",
  "gateway.api.error.organizationRequired": "Select an organization before using your MongolGPT account.",
  "gateway.api.error.modelNotSupported": "Model {{model}} is not supported",
  "gateway.api.error.modelFormatNotSupported": "Model {{model}} is not supported for format {{format}}",
  "gateway.api.error.noProviderAvailable": "No provider available",
  "gateway.api.error.providerNotSupported": "Provider {{provider}} not supported",
  "gateway.api.error.missingApiKey": "Missing API key.",
  ...
  "gateway.api.error.modelDisabled": "Model is disabled",
  "gateway.api.error.trialEnded": "The free allowance for {{model}} has ended. Choose a plan to continue: {{link}}",
