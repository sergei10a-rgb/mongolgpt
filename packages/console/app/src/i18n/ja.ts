...
export const dict = {
  ...
  "black.meta.title": "MongolGPT Black | 世界最高峰のコーディングモデルすべてにアクセス",
  "black.meta.description": "MongolGPT Black サブスクリプションプランで、Claude、GPT、Gemini などにアクセス。",
  "black.hero.title": "世界最高峰のコーディングモデルすべてにアクセス",
  "black.hero.subtitle": "Claude、GPT、Gemini などを含む",
  "black.title": "MongolGPT Black | 料金",
  ...
  "black.workspace.title": "MongolGPT Black | ワークスペースの選択",
  "black.workspace.selectPlan": "このプランのワークスペースを選択してください",
  "black.workspace.name": "ワークスペース {{n}}",
  "black.subscribe.title": "MongolGPT Black を購読する",
  ...
  "black.subscribe.success.title": "MongolGPT Black ウェイトリストに登録されました",
  ...
  "workspace.black.subscription.message": "あなたは MongolGPT Black を月額 ${{plan}} で購読しています。",
  ...
  "workspace.black.waitlist.joined":
    "あなたは月額 ${{plan}} の MongolGPT Black プランのウェイトリストに登録されています。",
  "workspace.black.waitlist.ready": "月額 ${{plan}} の MongolGPT Black プランに登録する準備ができました。",
  ...
  "workspace.lite.black.message":
    "現在 MongolGPT Black を購読中、またはウェイティングリストに登録されています。Go に切り替える場合は、先に登録を解除してください。",
