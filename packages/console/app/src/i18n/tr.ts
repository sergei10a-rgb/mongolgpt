...
export const dict = {
  ...
  "black.meta.title": "MongolGPT Black | Dünyanın en iyi kodlama modellerine erişin",
  "black.meta.description": "MongolGPT Black abonelik planlarıyla Claude, GPT, Gemini ve daha fazlasına erişin.",
  "black.hero.title": "Dünyanın en iyi kodlama modellerine erişin",
  "black.hero.subtitle": "Claude, GPT, Gemini ve daha fazlası dahil",
  "black.title": "MongolGPT Black | Fiyatlandırma",
  ...
  "black.workspace.title": "MongolGPT Black | Çalışma Alanı Seç",
  "black.workspace.selectPlan": "Bu plan için bir çalışma alanı seçin",
  "black.workspace.name": "Çalışma Alanı {{n}}",
  "black.subscribe.title": "MongolGPT Black'e Abone Ol",
  ...
  "black.subscribe.success.title": "MongolGPT Black bekleme listesindesiniz",
  ...
  "workspace.black.subscription.message": "Aylık ${{plan}} karşılığında MongolGPT Black'e abonesiniz.",
  ...
  "workspace.black.waitlist.joined": "Aylık ${{plan}} MongolGPT Black planı için bekleme listesindesiniz.",
  "workspace.black.waitlist.ready": "Sizi ayda {{plan}} $ tutarındaki MongolGPT Black planına kaydetmeye hazırız.",
  ...
  "workspace.lite.black.message":
    "Şu anda MongolGPT Black abonesisiniz veya bekleme listesindesiniz. Go'ya geçmek istiyorsanız lütfen önce aboneliğinizi iptal edin.",
