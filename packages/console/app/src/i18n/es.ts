...
export const dict = {
  ...
  "black.meta.title": "MongolGPT Black | Accede a los mejores modelos de codificación del mundo",
  "black.meta.description":
    "Obtén acceso a Claude, GPT, Gemini y más con los planes de suscripción de MongolGPT Black.",
  ...
  "black.title": "MongolGPT Black | Precios",
  ...
  "black.workspace.title": "MongolGPT Black | Seleccionar Espacio de Trabajo",
  "black.workspace.selectPlan": "Selecciona un espacio de trabajo para este plan",
  "black.workspace.name": "Espacio de trabajo {{n}}",
  "black.subscribe.title": "Suscribirse a MongolGPT Black",
  ...
  "black.subscribe.success.title": "Estás en la lista de espera de MongolGPT Black",
  ...
  "workspace.black.subscription.message": "Estás suscrito a MongolGPT Black por ${{plan}} al mes.",
  ...
  "workspace.black.waitlist.joined": "Estás en la lista de espera para el plan MongolGPT Black de ${{plan}} al mes.",
  "workspace.black.waitlist.ready": "Estamos listos para inscribirte en el plan MongolGPT Black de ${{plan}} al mes.",
  ...
  "workspace.lite.black.message":
    "Actualmente estás suscrito a MongolGPT Black o estás en la lista de espera. Por favor, cancela la suscripción primero si deseas cambiar a Go.",
