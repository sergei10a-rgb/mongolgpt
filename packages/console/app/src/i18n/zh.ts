...
export const dict = {
  ...
  "gateway.api.error.rateLimitExceeded": "超出速率限制。请稍后重试。",
  "gateway.api.error.modelNotSupported": "不支持模型 {{model}}",
  "gateway.api.error.modelFormatNotSupported": "格式 {{format}} 不支持模型 {{model}}",
  "gateway.api.error.noProviderAvailable": "没有可用的提供商",
  "gateway.api.error.providerNotSupported": "不支持提供商 {{provider}}",
  "gateway.api.error.missingApiKey": "缺少 API 密钥。",
  "gateway.api.error.invalidApiKey": "无效的 API 密钥。",
  "gateway.api.error.subscriptionQuotaExceeded": "超出订阅配额。请在 {{retryIn}} 后重试。",
  "gateway.api.error.noPaymentMethod": "没有付款方式。请在此处添加付款方式：{{billingUrl}}",
  "gateway.api.error.insufficientBalance": "余额不足。请在此处管理您的计费：{{billingUrl}}",
  "gateway.api.error.workspaceMonthlyLimitReached":
    "您的工作区已达到每月支出限额 ${{amount}}。请在此处管理您的限额：{{billingUrl}}",
  "gateway.api.error.userMonthlyLimitReached": "您已达到每月支出限额 ${{amount}}。请在此处管理您的限额：{{membersUrl}}",
  "gateway.api.error.modelDisabled": "模型已禁用",
