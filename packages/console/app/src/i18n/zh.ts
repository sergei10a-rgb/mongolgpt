...
export const dict = {
  ...
  "temp.title": "MongolGPT | 专为终端打造的 AI 编程代理",
  ...
  "temp.feature.zen.beforeLink": "由 MongolGPT 提供的",
  ...
  "temp.screenshot.caption": "使用 Tokyonight 主题的 MongolGPT TUI",
  "temp.screenshot.alt": "使用 Tokyonight 主题的 MongolGPT TUI",
  "temp.logoLightAlt": "MongolGPT logo 亮色",
  "temp.logoDarkAlt": "MongolGPT logo 暗色",
  ...
  "home.faq.a3.p3": "虽然我们鼓励使用 Zen，但 MongolGPT 也支持所有主流提供商，如 OpenAI, Anthropic, xAI 等。",
  ...
  "home.faq.a6": "MongolGPT 是 100% 免费使用的。它还自带一组免费模型。如果您连接其他提供商，可能会产生额外费用。",
  "home.faq.q7": "数据和隐私如何？",
  ...
  "home.zenCta.body":
    "Zen 为您提供一组精选的 AI 模型，这些模型经过 MongolGPT 专门针对编程代理的测试和基准测试。无需担心不同提供商之间不稳定的性能和质量，直接使用行之有效的验证模型。",
  "home.zenCta.link": "了解 Zen",

  "zen.title": "MongolGPT Zen | 为编程代理精选的可靠、优化模型",
  "zen.hero.title": "为编程代理打造的可靠、优化模型",
  "zen.hero.body":
    "Zen 为您提供一组精选的 AI 模型，这些模型经过 MongolGPT 专门针对编程代理的测试和基准测试。无需担心不稳定的性能和质量，直接使用行之有效的验证模型。",

  "zen.faq.q1": "什么是 MongolGPT Zen？",
  "zen.faq.a1": "Zen 是一组由 MongolGPT 团队创建的，专门针对编程代理进行测试和基准测试的 AI 模型精选集。",
  "zen.faq.q2": "为什么 Zen 更准确？",
  "zen.faq.a2":
    "Zen 仅提供经过专门针对编程代理测试和基准测试的模型。正如你不会用黄油刀切牛排一样，也不要用糟糕的模型来写代码。",
  "zen.faq.q3": "Zen 更便宜吗？",
  "zen.faq.a3":
    "Zen 不以盈利为目的。Zen 将模型提供商的成本直接传递给您。Zen 的使用量越高，MongolGPT 就越能协商出更好的费率并回馈给您。",
  "zen.faq.q4": "Zen 多少钱？",
  ...
  "zen.faq.a4.p3": "为覆盖成本，MongolGPT 仅收取少量支付处理费，每充值 $20 收取 $1.23。",
  "zen.faq.q5": "数据和隐私如何？",
  ...
  "zen.faq.a8":
    "虽然 Zen 与 MongolGPT 配合效果极佳，但您可以在任何代理中使用 Zen。请按照您首选编程代理中的设置说明进行操作。",
  ...
  "go.title": "MongolGPT Go | 人人可用的低成本编程模型",
  ...
  "go.problem.body":
    "我们致力于将 MongolGPT 体验带给尽可能多的人。MongolGPT Go 是一款低成本订阅服务：首月 $5，之后 $10/月。它提供充裕的额度，并让您能可靠地使用最强大的开源模型。",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go 起价为首月 $5，之后 $10/月。您可以将其与 MongolGPT 或任何代理搭配使用。",
  ...
  "zen.api.error.trialEnded": "{{model}} 的限免活动已结束。您可以订阅 MongolGPT Go 继续使用该模型 - {{link}}",

  "black.meta.title": "MongolGPT Black | 访问全球顶尖编程模型",
  "black.meta.description": "通过 MongolGPT Black 订阅计划使用 Claude, GPT, Gemini 等模型。",
  "black.hero.title": "访问全球顶尖编程模型",
  "black.hero.subtitle": "包括 Claude, GPT, Gemini 等",
  "black.title": "MongolGPT Black | 定价",
  ...
  "black.workspace.title": "MongolGPT Black | 选择工作区",
  "black.workspace.selectPlan": "为此计划选择一个工作区",
  "black.workspace.name": "工作区 {{n}}",
  "black.subscribe.title": "订阅 MongolGPT Black",
  ...
  "black.subscribe.success.title": "您已加入 MongolGPT Black 候补名单",
  ...
  "workspace.newUser.feature.lockin.body":
    "将 Zen 与任何编程代理结合使用，并在需要时继续在 MongolGPT 中使用其他提供商。",
  ...
  "workspace.black.subscription.message": "您已订阅 MongolGPT Black，价格为每月 ${{plan}}。",
  ...
  "workspace.black.waitlist.joined": "您已加入每月 ${{plan}} 的 MongolGPT Black 计划候补名单。",
  "workspace.black.waitlist.ready": "我们已准备好将您加入每月 ${{plan}} 的 MongolGPT Black 计划。",
  ...
  "workspace.lite.subscription.message": "您已订阅 MongolGPT Go。",
  ...
  "workspace.lite.subscription.selectProvider":
    "在你的 mongolgpt 配置中选择「MongolGPT Go」作为提供商，即可使用 Go 模型。",
  "workspace.lite.black.message": "您当前已订阅 MongolGPT Black 或在候补名单中。如需切换到 Go，请先取消订阅。",
  "workspace.lite.other.message": "此工作区中的另一位成员已经订阅了 MongolGPT Go。每个工作区只有一名成员可以订阅。",
  "workspace.lite.promo.description":
    "MongolGPT Go 起价为 {{price}}，之后 $10/月，并提供对流行开放编码模型的可靠访问，同时享有充裕的使用限额。",
  ...
  "download.faq.a3.afterZen": "，但 MongolGPT 支持所有主流提供商，如 OpenAI, Anthropic, xAI 等。",

  "download.faq.a5.p1": "MongolGPT 是 100% 免费使用的。",
  "download.faq.a5.p2.beforeZen":
    "任何额外费用都来自您对模型提供商的订阅。虽然 MongolGPT 支持任何模型提供商，但我们建议使用",
