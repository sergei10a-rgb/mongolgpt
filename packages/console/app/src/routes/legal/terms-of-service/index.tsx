...
export default function TermsOfService() {
  ...
  return (
    <main data-page="legal">
      <Title>MongolGPT | Terms of Service</Title>
      <LocaleLinks path="/legal/terms-of-service" />
      <Meta name="description" content="MongolGPT terms of service" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <p>
                Welcome to MongolGPT. Please read on to learn the rules and restrictions that govern your use of
                MongolGPT&apos;s website, inference product and hosted software offering (the "Services"). If you have
              ...
              <p>
                ...
                <strong>MONGOLGPT</strong> ("MongolGPT," "we" and "us"). Your use of the Services in any
                ...
                <a href={language.route("/legal/privacy-policy")}>https://mongolgpt.duckdns.org/legal/privacy-policy</a>
                .{" "}
                <strong>
              ...
              <h2 id="what-is-mongolgpt">What is MongolGPT?</h2>
              <p>
                MongolGPT is an AI-powered coding agent that helps you write, understand, and modify code using large
                language models. Certain of these large language models are provided by third parties ("Third Party
                Models") and certain of these models are provided directly by us if you use the MongolGPT Zen paid
                offering ("Zen"). Regardless of whether you use Third Party Models or Zen, MongolGPT enables you to
              ...
              <p>
                ...
                our site located at mongolgpt.duckdns.org, send you an email, and/or notify you by some other means.
              </p>
              ...
              <p>
                MongolGPT takes the privacy of its users very seriously. For the current MongolGPT Privacy Policy,
                please click here{" "}
                <a href="https://mongolgpt.duckdns.org/legal/privacy-policy">
                  https://mongolgpt.duckdns.org/legal/privacy-policy
                </a>
                .
              </p>
              ...
              <p>
                ...
                us personal information, please contact us at <a href="mailto:help@mongolgpt.duckdns.org">help@mongolgpt.duckdns.org</a>.
              </p>

              <h2 id="what-are-the-basics">What are the basics of using MongolGPT?</h2>
              <p>
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <li>
                  ...
                  privacy laws or any other purpose not reasonably intended by MongolGPT;
                </li>
                <li>
              ...
              <p>
                If you use MongolGPT with Third Party Models, then your Content will be subject to the data retention
              ...
              <p>
                ...
                MongolGPT. Your ability to access Third Party Models is contingent on you having API keys or otherwise
                having the right to access such Third Party Models.
              </p>

              <p>
                MongolGPT has no control over, and assumes no responsibility for, the content, accuracy, privacy
              ...
              <h2 id="will-mongolgpt-ever-change-the-services">Will MongolGPT ever change the Services?</h2>
              <p>
              ...
              <p>
                ...
                <a href={language.route("/zen")}>https://mongolgpt.duckdns.org/zen</a> for a description of the current
              ...
              <p>
                ...
                <a href="https://mongolgpt.duckdns.org/auth">https://mongolgpt.duckdns.org/auth</a>.
              </p>
              ...
              <p>
                MongolGPT is also free to terminate (or suspend access to) your use of the Services for any reason in
                our discretion, including your breach of these Terms. MongolGPT has the sole right to decide whether you
              ...
              <p>
                MongolGPT and its licensors, suppliers, partners, parent, subsidiaries or affiliated entities, and each
                of their respective officers, directors, members, employees, consultants, contract employees,
                representatives and agents, and each of their respective successors and assigns (MongolGPT and all such
                parties together, the "MongolGPT Parties") make no representations or warranties concerning the
                Services, including without limitation regarding any Content contained in or accessed through the
                Services, and the MongolGPT Parties will not be responsible or liable for the accuracy, copyright
                ...
                any way related to your participation in, the Services. The MongolGPT Parties make no representations or
                warranties regarding suggestions or recommendations of services or products offered or purchased through
                or in connection with the Services. THE SERVICES AND CONTENT ARE PROVIDED BY MONGOLGPT (AND ITS
              ...
              <p>
                ...
                MONGOLGPT PARTIES BE LIABLE TO YOU OR TO ANY OTHER PERSON FOR (A) ANY INDIRECT, SPECIAL, INCIDENTAL,
                ...
                TO MONGOLGPT IN CONNECTION WITH THE SERVICES IN THE TWELVE (12) MONTH PERIOD PRECEDING THIS APPLICABLE
              ...
              <h3>Indemnity</h3>
              <p>
                You agree to indemnify and hold the MongolGPT Parties harmless from and against any and all claims,
              ...
              <p>
                ...
                Services account, in any way (by operation of law or otherwise) without MongolGPT's prior written
              ...
              <p>
                ...
                disputes and claims with MongolGPT and limits the manner in which you can seek relief from MongolGPT.
                Both you and MongolGPT acknowledge and agree that for the purposes of any dispute arising out of or
                relating to the subject matter of these Terms, MongolGPT's officers, directors, employees and
              ...
              <p>
                The Rules will govern payment of all arbitration fees. MongolGPT will pay all arbitration fees for
                claims less than seventy-five thousand ($75,000) dollars. MongolGPT will not seek its attorneys' fees
              ...
              <p>
                Either you or MongolGPT may assert claims, if they qualify, in small claims court in New Castle County,
              ...
              <p>
                YOU AND MONGOLGPT WAIVE ANY CONSTITUTIONAL AND STATUTORY RIGHTS TO GO TO COURT AND HAVE A TRIAL IN FRONT
                OF A JUDGE OR JURY. You and MongolGPT are instead choosing to have claims and disputes resolved by
                ...
                you and MongolGPT over whether to vacate or enforce an arbitration award, YOU AND MONGOLGPT WAIVE ALL
              ...
              <p>
                ...
                MongolGPT is entitled to arbitration; instead all claims and disputes will be resolved in a court as set
                forth in (g) below.
              </p>
              ...
              <p>
                ...
                agreement permits either you or MongolGPT to litigate any dispute arising out of or relating to the
                subject matter of these Terms in court, then the foregoing arbitration agreement will not apply to
                either party, and both you and MongolGPT agree that any judicial proceeding (other than small claims
              ...
              <p>
                ...
                the MongolGPT may, in its sole discretion, do any of the foregoing on your behalf or for itself as it
                ...
                Terms shall otherwise remain in full force and effect and enforceable. You and MongolGPT agree that
                these Terms are the complete and exclusive statement of the mutual understanding between you and
                MongolGPT, and that these Terms supersede and cancel all previous written and oral agreements,
                communications and other understandings relating to the subject matter of these Terms. You hereby
                acknowledge and agree that you are not an employee, agent, partner, or joint venture of MongolGPT, and
                you do not have any authority of any kind to bind MongolGPT in any respect whatsoever.
              </p>

              <p>
                Except as expressly set forth in the section above regarding the arbitration agreement, you and
                MongolGPT agree there are no third-party beneficiaries intended under these Terms.
              </p>
            </article>
          </section>
        </div>
