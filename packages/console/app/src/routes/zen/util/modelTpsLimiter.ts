import { and, Database, inArray, sql } from "@mongolgpt/console-core/drizzle/index.js"
import { ModelTpsRateLimitTable } from "@mongolgpt/console-core/schema/ip.sql.js"
      ...
      await Database.use((tx) =>
        tx
          ...
          .onConflictDoUpdate({
            ...
            set: {
              qualify: sql`COALESCE(${ModelTpsRateLimitTable.qualify}, 0) + ${qualify}`,
              unqualify: sql`COALESCE(${ModelTpsRateLimitTable.unqualify}, 0) + ${unqualify}`,
            },
          }),
      )
    },
