import { and, Database, eq, inArray, sql } from "@mongolgpt/console-core/drizzle/index.js"
import { ModelTpmRateLimitTable } from "@mongolgpt/console-core/schema/ip.sql.js"
      ...
      await Database.use((tx) =>
        tx
          ...
          .onConflictDoUpdate({
            ...
            set: { count: sql`COALESCE(${ModelTpmRateLimitTable.count}, 0) + ${usage}` },
          }),
      )
    },
  }
