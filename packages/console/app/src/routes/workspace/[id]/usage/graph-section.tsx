import { and, Database, eq, gte, inArray, isNull, lt, or, sql, sum } from "@mongolgpt/console-core/drizzle/index.js"
import { UsageTable } from "@mongolgpt/console-core/schema/billing.sql.js"
...
async function getCosts(workspaceID: string, year: number, month: number, tzOffset: string) {
  ...
  return withActor(async () => {
    ...
    const dateExpr = sql<string>`date(${UsageTable.timeCreated} / 1000, 'unixepoch', ${tzOffset})`
...
// Compute the UTC offset (in SQLite modifier format like "+05:30") for the
