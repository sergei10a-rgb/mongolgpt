...
import { Database, eq, and, isNull } from "@mongolgpt/console-core/drizzle/index.js"
import { BillingTable, LiteTable } from "@mongolgpt/console-core/schema/billing.sql.js"
        ...
        {(sub) => (
          <section class={styles.root}>
            ...
            <div data-slot="beta-notice">
              ...
              <a href={language.route("/docs/providers/#mongolgpt-go")} target="_blank" rel="noopener noreferrer">
