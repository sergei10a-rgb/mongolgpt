...
import desktopAppIcon from "../../asset/lander/mongolgpt-desktop-icon.png"
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              ...
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g mongolgpt")}>
                <code>
                  npm i -g <strong>mongolgpt</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g mongolgpt")}>
                <code>
                  bun add -g <strong>mongolgpt</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install mongolgpt")}>
                <code>
                  brew install <strong>mongolgpt</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S mongolgpt")}>
                <code>
                  paru -S <strong>mongolgpt</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask mongolgpt-desktop")}>
                <code>
                  brew install --cask <strong>mongolgpt-desktop</strong>
                </code>
                <CopyStatus />
              </button>
