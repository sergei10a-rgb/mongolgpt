...
function getDownloadPlatform(os: OS): DownloadPlatform | null {
  if (os === "Windows") return "windows-x64-nsis"
  return null
}
        ...
        <div data-component="content">
          <section data-component="download-hero">
            ...
            <div data-component="hero-text">
              ...
              <Show when={getDownloadPlatform(detectedOS())}>
                {(platform) => (
                  <a href={language.route(getDownloadHref(platform()))} data-component="download-button">
                    <IconDownload />
                    {i18n.t("download.hero.button", { os: "Windows" })}
                  </a>
                )}
              </Show>
            </div>
