import { Database, eq } from "@mongolgpt/console-core/drizzle/index.js"
import { ModelStickyProviderTable } from "@mongolgpt/console-core/schema/ip.sql.js"
    ...
    set: async (providerId: string) => {
      ...
      await Database.use((tx) =>
        tx
          ...
          .onConflictDoUpdate({
            target: ModelStickyProviderTable.id,
            set: {
              providerId,
            },
          }),
