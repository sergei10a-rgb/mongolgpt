      ...
      await Promise.all([
        ...
        tx
          .select({
            ...
            timeExpired: PaymentInvoiceTable.time_expired,
            timeCancelled: PaymentInvoiceTable.time_cancelled,
    ...
    return {
      ...
      invoices: recentInvoices.map((invoice) => {
        ...
        return {
          ...
          timeExpired: invoice.timeExpired?.toISOString() ?? null,
          timeCancelled: invoice.timeCancelled?.toISOString() ?? null,
