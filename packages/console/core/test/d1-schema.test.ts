...
const contract = {
  ...
  SupportMessageTable: ["id", "ticket_id", "author_type", "account_id", "admin_id", "body", "internal", "time_created"],
  AdminAuditLogTable: [
    "id",
    "admin_id",
    "actor_email",
  ...
  SubscriptionTable: [
    ...
    "timeWeeklyRequestsUpdated",
    "timeMonthlyCostUpdated",
    "timeMonthlyTokensUpdated",
    "timeMonthlyRequestsUpdated",
  ],
