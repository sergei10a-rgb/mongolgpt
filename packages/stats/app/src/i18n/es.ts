export const dict = {
  "app.title": "Clasificaciones de uso de modelos de IA | MongolGPT Data",
  "app.description":
    "Explora el uso de MongolGPT en modelos de IA, incluido el volumen de tokens, clasificaciones, cuota de mercado, precios de tokens, coste por sesión, ratio de caché y desgloses geográficos.",
  "app.unfurlAlt": "Logotipo textual de MongolGPT Data sobre un fondo oscuro con patrón",
  ...
  "header.githubAria": "Dale una estrella a MongolGPT en GitHub",
  "header.github": "GitHub",
  "header.tryMongolGPT": "Probar MongolGPT",
  ...
  "footer.homeAria": "Inicio de MongolGPT",
  ...
  "modal.title": "Boletín de MongolGPT",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos en MongolGPT.",
  "home.noUsageTitle": "Sin datos de uso",
  "home.noUsageDescription": "Ninguna fila de modelo coincidió con este rango de fechas.",
  "home.noLeaderboardTitle": "Sin datos de clasificación",
  "home.noLeaderboardDescription": "Ninguna fila de modelo coincidió con este rango de fechas.",
  ...
  "home.uniqueUsersDescription": "Usuarios únicos diarios de MongolGPT por modelo.",
  ...
  "lab.title": "Uso y clasificaciones de modelos de IA de {{lab}} | MongolGPT Data",
  "lab.description":
    "Compara modelos de {{lab}} usados en MongolGPT, incluido uso de tokens, clasificaciones de modelos, ventanas de contexto, fechas de lanzamiento, costes y datos específicos del modelo.",
  "lab.loadingTitle": "Laboratorio de modelos",
  "lab.loadingDescription": "Leyendo disponibilidad de modelos y uso reciente de MongolGPT.",
  "lab.notFound": "Ningún modelo coincidió con este laboratorio.",
  "lab.heroPrefix": "Explora {{count}} modelos de {{lab}} usados en MongolGPT",
  ...
  "lab.shareOfUsage": "{{share}} del uso reciente de MongolGPT",
  "lab.usageTitle": "Uso de tokens de {{lab}}",
  "lab.usageDescription": "Volumen diario de tokens de MongolGPT durante los últimos dos meses.",
  ...
  "lab.usage": "Uso",
  "lab.share": "Cuota",
  "model.title": "Uso, coste y posición de {{model}} | MongolGPT Data",
  "model.description":
    "Consulta datos de uso de {{model}} en MongolGPT, incluido volumen de tokens, posición semanal, mezcla de tokens, costes, ratio de caché, sesiones, desgloses geográficos y modelos similares.",
  ...
  "model.catalogFallback":
    "Datos del modelo desde el índice compartido de modelos. El uso de MongolGPT aparecerá cuando este modelo tenga actividad.",
  "model.unranked": "Sin clasificación en el uso de MongolGPT de la semana pasada",
  "model.ranked": "Clasificado #{{rank}} en el uso de MongolGPT de la semana pasada",
  ...
  "model.noCurrentUsage": "Sin uso de MongolGPT en la ventana de datos actual.",
  ...
  "model.overviewDescription": "Tokens recientes de MongolGPT, usuarios únicos y posición de mercado.",
  "model.noSummaryTitle": "Sin resumen de uso",
  "model.noSummaryDescription": "Este modelo aún no tiene filas de uso de MongolGPT.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volumen diario de tokens de MongolGPT durante la ventana reciente de dos meses.",
  ...
  "model.usersDescription": "Usuarios únicos diarios de MongolGPT durante la ventana reciente de dos meses.",
  ...
  "model.efficiencyDescription": "Coste, comportamiento de caché y forma media de sesión de MongolGPT.",
  ...
  "model.geoDescription": "Tokens del modelo de MongolGPT usados por país.",
  "model.noGeoTitle": "Sin datos geográficos",
  "model.noGeoDescription": "Ninguna fila geográfica de MongolGPT coincidió con este modelo.",
  "model.worldMap": "Mapa mundial del uso de tokens del modelo por país",
  "model.peersDescription": "Modelos cercanos por volumen reciente de tokens de MongolGPT.",
