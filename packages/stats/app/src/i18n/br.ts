export const dict = {
  "app.title": "Ranking de uso de modelos de IA | MongolGPT Data",
  "app.description":
    "Explore o uso do MongolGPT em modelos de IA, incluindo volume de tokens, rankings, participação de mercado, preço por token, custo por sessão, taxa de cache e distribuição geográfica.",
  "app.unfurlAlt": "Logotipo do MongolGPT Data sobre um fundo escuro padronizado",
  ...
  "header.githubAria": "Dar estrela ao MongolGPT no GitHub",
  "header.github": "GitHub",
  "header.tryMongolGPT": "Experimente o MongolGPT",
  ...
  "footer.homeAria": "Início do MongolGPT",
  ...
  "modal.title": "Newsletter do MongolGPT",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos no MongolGPT.",
  "home.noUsageTitle": "Sem dados de uso",
  "home.noUsageDescription": "Nenhuma linha de modelo correspondeu a este intervalo de datas.",
  "home.noLeaderboardTitle": "Sem dados de classificação",
  "home.noLeaderboardDescription": "Nenhuma linha de modelo correspondeu a este intervalo de datas.",
  ...
  "home.uniqueUsersDescription": "Usuários únicos diários do MongolGPT por modelo.",
  ...
  "lab.title": "Uso e ranking de modelos de IA da {{lab}} | MongolGPT Data",
  "lab.description":
    "Compare modelos da {{lab}} usados no MongolGPT, incluindo uso de tokens, ranking de modelos, janelas de contexto, datas de lançamento, custos e dados específicos de cada modelo.",
  "lab.loadingTitle": "Laboratório de modelos",
  "lab.loadingDescription": "Lendo disponibilidade de modelos e uso recente do MongolGPT.",
  "lab.notFound": "Nenhum modelo correspondeu a este laboratório.",
  "lab.heroPrefix": "Explore {{count}} modelos da {{lab}} usados no MongolGPT",
  ...
  "lab.shareOfUsage": "{{share}} do uso recente do MongolGPT",
  "lab.usageTitle": "Uso de tokens da {{lab}}",
  "lab.usageDescription": "Volume diário de tokens do MongolGPT nos últimos dois meses.",
  ...
  "model.title": "Uso, custo e posição de {{model}} | MongolGPT Data",
  "model.description":
    "Veja dados de uso de {{model}} no MongolGPT, incluindo volume de tokens, ranking semanal, combinação de tokens, custos, taxa de cache, sessões, distribuição geográfica e modelos pares.",
  ...
  "model.catalogFallback":
    "Fatos do modelo do índice compartilhado de modelos. O uso no MongolGPT aparece quando este modelo tiver atividade.",
  "model.unranked": "Sem classificação no uso do MongolGPT da última semana",
  "model.ranked": "Classificado em #{{rank}} no uso do MongolGPT da última semana",
  ...
  "model.noCurrentUsage": "Sem uso do MongolGPT na janela de dados atual.",
  ...
  "model.overviewDescription": "Tokens recentes do MongolGPT, usuários únicos e posição de mercado.",
  "model.noSummaryTitle": "Sem resumo de uso",
  "model.noSummaryDescription": "Este modelo ainda não tem linhas de uso do MongolGPT.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume diário de tokens do MongolGPT na janela recente de dois meses.",
  ...
  "model.usersDescription": "Usuários únicos diários do MongolGPT na janela recente de dois meses.",
  ...
  "model.efficiencyDescription": "Custo, comportamento de cache e formato médio da sessão do MongolGPT.",
  ...
  "model.geoDescription": "Tokens do modelo MongolGPT usados por país.",
  "model.noGeoTitle": "Sem dados geográficos",
  "model.noGeoDescription": "Nenhuma linha geográfica do MongolGPT correspondeu a este modelo.",
  "model.worldMap": "Mapa-múndi do uso de tokens do modelo por país",
  "model.peersDescription": "Modelos próximos por volume recente de tokens do MongolGPT.",
