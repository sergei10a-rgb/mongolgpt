export const dict = {
  ...
  "app.description":
    "Explore o uso do MongolGPT Go em modelos de IA, incluindo volume de tokens, rankings, participação de mercado, preço por token, custo por sessão, taxa de cache e distribuição geográfica.",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos no MongolGPT Go.",
  ...
  "home.uniqueUsersDescription": "Usuários únicos diários do MongolGPT Go por modelo.",
  ...
  "lab.description":
    "Compare modelos da {{lab}} usados no MongolGPT Go, incluindo uso de tokens, ranking de modelos, janelas de contexto, datas de lançamento, custos e dados específicos de cada modelo.",
  ...
  "model.description":
    "Veja dados de uso de {{model}} no MongolGPT Go, incluindo volume de tokens, ranking semanal, combinação de tokens, custos, taxa de cache, sessões, distribuição geográfica e modelos pares.",
  ...
  "model.catalogFallback":
    "Fatos do modelo do índice compartilhado de modelos. O uso no MongolGPT Go aparece quando este modelo tiver atividade.",
  "model.unranked": "Sem classificação no uso do MongolGPT Go da última semana",
  "model.ranked": "Classificado em #{{rank}} no uso do MongolGPT Go da última semana",
  ...
  "model.noCurrentUsage": "Sem uso do MongolGPT Go na janela de dados atual.",
  ...
  "model.overviewDescription": "Tokens recentes do MongolGPT Go, usuários únicos e posição de mercado.",
  "model.noSummaryTitle": "Sem resumo de uso",
  "model.noSummaryDescription": "Este modelo ainda não tem linhas de uso do MongolGPT Go.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume diário de tokens do MongolGPT Go na janela recente de dois meses.",
  ...
  "model.usersDescription": "Usuários únicos diários do MongolGPT Go na janela recente de dois meses.",
  ...
  "model.efficiencyDescription": "Custo, comportamento de cache e formato médio da sessão do MongolGPT Go.",
  ...
  "model.geoDescription": "Tokens do modelo MongolGPT Go usados por país.",
  "model.noGeoTitle": "Sem dados geográficos",
  "model.noGeoDescription": "Nenhuma linha geográfica do MongolGPT Go correspondeu a este modelo.",
  "model.worldMap": "Mapa-múndi do uso de tokens do modelo por país",
  "model.peersDescription": "Modelos próximos por volume recente de tokens do MongolGPT Go.",
