export const dict = {
  "app.title": "Rankingi użycia modeli AI | MongolGPT Data",
  "app.description":
    "Przeglądaj użycie MongolGPT w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny MongolGPT Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę MongolGPT na GitHub",
  "header.github": "GitHub",
  "header.tryMongolGPT": "Wypróbuj MongolGPT",
  ...
  "footer.homeAria": "Strona główna MongolGPT",
  ...
  "home.topModelsDescription": "Użycie modeli w MongolGPT.",
  "home.noUsageTitle": "Brak danych użycia",
  "home.noUsageDescription": "Żadne wiersze modeli nie pasowały do tego zakresu dat.",
  "home.noLeaderboardTitle": "Brak danych rankingu",
  "home.noLeaderboardDescription": "Żadne wiersze modeli nie pasowały do tego zakresu dat.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy MongolGPT według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | MongolGPT Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w MongolGPT, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia MongolGPT.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w MongolGPT",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia MongolGPT",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów MongolGPT z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | MongolGPT Data",
  "model.description":
    "Zobacz dane użycia {{model}} w MongolGPT, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie MongolGPT pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu MongolGPT z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu MongolGPT z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia MongolGPT w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny MongolGPT, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia MongolGPT.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów MongolGPT w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy MongolGPT w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji MongolGPT.",
  ...
  "model.geoDescription": "Tokeny modelu MongolGPT użyte według kraju.",
  "model.noGeoTitle": "Brak danych geograficznych",
  "model.noGeoDescription": "Żadne wiersze geograficzne MongolGPT nie pasowały do tego modelu.",
  "model.worldMap": "Mapa świata użycia tokenów modelu według kraju",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów MongolGPT.",
