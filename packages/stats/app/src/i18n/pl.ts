export const dict = {
  ...
  "app.description":
    "Przeglądaj użycie MongolGPT Go w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  ...
  "home.topModelsDescription": "Użycie modeli w MongolGPT Go.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy MongolGPT Go według modelu.",
  ...
  "lab.description":
    "Porównaj modele {{lab}} używane w MongolGPT Go, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  ...
  "model.description":
    "Zobacz dane użycia {{model}} w MongolGPT Go, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie MongolGPT Go pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu MongolGPT Go z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu MongolGPT Go z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia MongolGPT Go w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny MongolGPT Go, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia MongolGPT Go.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów MongolGPT Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy MongolGPT Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji MongolGPT Go.",
  ...
  "model.geoDescription": "Tokeny modelu MongolGPT Go użyte według kraju.",
  "model.noGeoTitle": "Brak danych geograficznych",
  "model.noGeoDescription": "Żadne wiersze geograficzne MongolGPT Go nie pasowały do tego modelu.",
  "model.worldMap": "Mapa świata użycia tokenów modelu według kraju",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów MongolGPT Go.",
