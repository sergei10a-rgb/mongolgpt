export const dict = {
  ...
  "app.description":
    "MongolGPT Go kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  ...
  "home.topModelsDescription": "MongolGPT Go genelinde model kullanımı.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz MongolGPT Go kullanıcıları.",
  ...
  "lab.description":
    "MongolGPT Go'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  ...
  "model.description":
    "{{model}} için MongolGPT Go kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda MongolGPT Go kullanımı görünür.",
  "model.unranked": "Geçen haftaki MongolGPT Go kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki MongolGPT Go kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde MongolGPT Go kullanımı yok.",
  ...
  "model.overviewDescription": "Son MongolGPT Go tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz MongolGPT Go kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük MongolGPT Go token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz MongolGPT Go kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama MongolGPT Go oturum yapısı.",
  ...
  "model.geoDescription": "Ülkeye göre kullanılan MongolGPT Go model tokenları.",
  "model.noGeoTitle": "Coğrafi veri yok",
  "model.noGeoDescription": "Bu modelle eşleşen MongolGPT Go coğrafi satırı yok.",
  "model.worldMap": "Ülkeye göre model token kullanımının dünya haritası",
  "model.peersDescription": "Son MongolGPT Go token hacmine göre yakındaki modeller.",
