export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | MongolGPT Data",
  "app.description":
    "MongolGPT kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde MongolGPT Data logosu",
  ...
  "header.githubAria": "GitHub'da MongolGPT'a yıldız ver",
  "header.github": "GitHub",
  "header.tryMongolGPT": "MongolGPT'u dene",
  ...
  "home.topModelsDescription": "MongolGPT genelinde model kullanımı.",
  "home.noUsageTitle": "Kullanım verisi yok",
  "home.noUsageDescription": "Bu tarih aralığıyla eşleşen model satırı yok.",
  "home.noLeaderboardTitle": "Sıralama verisi yok",
  "home.noLeaderboardDescription": "Bu tarih aralığıyla eşleşen model satırı yok.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz MongolGPT kullanıcıları.",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | MongolGPT Data",
  "lab.description":
    "MongolGPT'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  "lab.loadingTitle": "Model Laboratuvarı",
  "lab.loadingDescription": "Model kullanılabilirliği ve son MongolGPT kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "MongolGPT'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son MongolGPT kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük MongolGPT token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | MongolGPT Data",
  "model.description":
    "{{model}} için MongolGPT kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda MongolGPT kullanımı görünür.",
  "model.unranked": "Geçen haftaki MongolGPT kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki MongolGPT kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde MongolGPT kullanımı yok.",
  ...
  "model.overviewDescription": "Son MongolGPT tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz MongolGPT kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük MongolGPT token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz MongolGPT kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama MongolGPT oturum yapısı.",
  ...
  "model.geoDescription": "Ülkeye göre kullanılan MongolGPT model tokenları.",
  "model.noGeoTitle": "Coğrafi veri yok",
  "model.noGeoDescription": "Bu modelle eşleşen MongolGPT coğrafi satırı yok.",
  "model.worldMap": "Ülkeye göre model token kullanımının dünya haritası",
  "model.peersDescription": "Son MongolGPT token hacmine göre yakındaki modeller.",
