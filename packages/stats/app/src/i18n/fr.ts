export const dict = {
  "app.title": "Classements d'utilisation des modèles d'IA | MongolGPT Data",
  "app.description":
    "Explorez l'utilisation d'MongolGPT par modèle d'IA, avec le volume de tokens, les classements, la part de marché, le prix des tokens, le coût par session, le taux de cache et les répartitions géographiques.",
  "app.unfurlAlt": "Logo textuel MongolGPT Data sur un fond sombre à motif",
  ...
  "header.githubAria": "Ajouter une étoile à MongolGPT sur GitHub",
  "header.github": "GitHub",
  "header.tryMongolGPT": "Essayer MongolGPT",
  ...
  "footer.homeAria": "Accueil MongolGPT",
  ...
  "modal.title": "Newsletter MongolGPT",
  ...
  "home.topModelsDescription": "Utilisation des modèles dans MongolGPT.",
  "home.noUsageTitle": "Aucune donnée d'utilisation",
  "home.noUsageDescription": "Aucune ligne de modèle ne correspondait à cette période.",
  "home.noLeaderboardTitle": "Aucune donnée de classement",
  "home.noLeaderboardDescription": "Aucune ligne de modèle ne correspondait à cette période.",
  ...
  "home.uniqueUsersDescription": "Utilisateurs uniques quotidiens d'MongolGPT par modèle.",
  ...
  "lab.title": "Utilisation et classements des modèles d'IA {{lab}} | MongolGPT Data",
  "lab.description":
    "Comparez les modèles {{lab}} utilisés dans MongolGPT, avec l'utilisation des tokens, les classements de modèles, les fenêtres de contexte, les dates de sortie, les coûts et les données propres aux modèles.",
  "lab.loadingTitle": "Laboratoire de modèles",
  "lab.loadingDescription": "Lecture de la disponibilité des modèles et de l'utilisation récente d'MongolGPT.",
  "lab.notFound": "Aucun modèle ne correspondait à ce laboratoire.",
  "lab.heroPrefix": "Explorez {{count}} modèles {{lab}} utilisés dans MongolGPT",
  ...
  "lab.shareOfUsage": "{{share}} de l'utilisation récente d'MongolGPT",
  "lab.usageTitle": "Utilisation des tokens {{lab}}",
  "lab.usageDescription": "Volume quotidien de tokens MongolGPT sur les deux derniers mois.",
  ...
  "lab.share": "Part",
  "model.title": "Utilisation, coût et rang de {{model}} | MongolGPT Data",
  "model.description":
    "Consultez les données d'utilisation MongolGPT de {{model}}, avec le volume de tokens, le rang hebdomadaire, la répartition des tokens, les coûts, le taux de cache, les sessions, les répartitions géographiques et les modèles proches.",
  ...
  "model.catalogFallback":
    "Faits du modèle issus de l'index partagé des modèles. L'utilisation MongolGPT apparaîtra dès que ce modèle aura de l'activité.",
  "model.unranked": "Non classé dans l'utilisation MongolGPT de la semaine dernière",
  "model.ranked": "Classé #{{rank}} dans l'utilisation MongolGPT de la semaine dernière",
  ...
  "model.noCurrentUsage": "Aucune utilisation MongolGPT dans la fenêtre de données actuelle.",
  ...
  "model.overviewDescription": "Tokens MongolGPT récents, utilisateurs uniques et position sur le marché.",
  "model.noSummaryTitle": "Aucun résumé d'utilisation",
  "model.noSummaryDescription": "Ce modèle n'a pas encore de lignes d'utilisation MongolGPT.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume quotidien de tokens MongolGPT sur la fenêtre récente de deux mois.",
  ...
  "model.usersDescription": "Utilisateurs uniques quotidiens d'MongolGPT sur la fenêtre récente de deux mois.",
  ...
  "model.efficiencyDescription": "Coût, comportement du cache et forme moyenne des sessions MongolGPT.",
  ...
  "model.geoDescription": "Tokens du modèle MongolGPT utilisés par pays.",
  "model.noGeoTitle": "Aucune donnée géographique",
  "model.noGeoDescription": "Aucune ligne géographique MongolGPT ne correspondait à ce modèle.",
  "model.worldMap": "Carte mondiale de l'utilisation des tokens du modèle par pays",
  "model.peersDescription": "Modèles proches par volume récent de tokens MongolGPT.",
