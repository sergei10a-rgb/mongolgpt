import mongolgptWordmarkDark from "../asset/logo-ornate-dark.svg"
...
function MongolGPTMark() {
  return (
    <svg data-slot="mongolgpt-mark" width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
    ...
    <div data-component="subscribe-modal" role="dialog" aria-modal="true" aria-labelledby="subscribe-title">
      ...
      <div data-slot="modal-panel">
        <div data-slot="modal-brand">
          <img data-slot="modal-logo" src={mongolgptWordmarkDark} alt="MongolGPT" />
          <button
