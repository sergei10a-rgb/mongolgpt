...
const en = {
  ...
  "home.topModelsDescription": "Usage of models across MongolGPT Go.",
  ...
  "home.uniqueUsersDescription": "Daily unique MongolGPT Go users by model.",
  ...
  "lab.description":
    "Compare {{lab}} models used in MongolGPT Go, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  ...
  "model.description":
    "View {{model}} MongolGPT Go usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. MongolGPT Go usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's MongolGPT Go usage",
  "model.ranked": "Ranked #{{rank}} across last week's MongolGPT Go usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No MongolGPT Go usage in the current data window.",
  ...
  "model.inputs": "Inputs",
  "model.overviewDescription": "Recent MongolGPT Go tokens, unique users, and market position.",
  "model.noSummaryTitle": "No usage summary",
  "model.noSummaryDescription": "This model has no MongolGPT Go usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Daily MongolGPT Go token volume over the recent two-month window.",
  ...
  "model.usersDescription": "Daily unique MongolGPT Go users over the recent two-month window.",
  ...
  "model.efficiencyDescription": "Cost, cache behavior, and average MongolGPT Go session shape.",
  ...
  "model.geoDescription": "MongolGPT Go model tokens used by country.",
  "model.noGeoTitle": "No geo data",
  "model.noGeoDescription": "No MongolGPT Go geo rows matched this model.",
  "model.worldMap": "World map of model token usage by country",
  "model.peersDescription": "Nearby models by recent MongolGPT Go token volume.",
