...
export const en = {
  ...
  "app.description":
    "Explore MongolGPT usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "MongolGPT Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star MongolGPT on GitHub",
  "header.github": "GitHub",
  "header.tryMongolGPT": "Try MongolGPT",
  ...
  "home.topModelsDescription": "Usage of models across MongolGPT.",
  "home.noUsageTitle": "No usage data",
  "home.noUsageDescription": "No model rows matched this date range.",
  "home.noLeaderboardTitle": "No leaderboard data",
  "home.noLeaderboardDescription": "No model rows matched this date range.",
  ...
  "home.uniqueUsersDescription": "Daily unique MongolGPT users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | MongolGPT Data",
  "lab.description":
    "Compare {{lab}} models used in MongolGPT, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent MongolGPT usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in MongolGPT",
  ...
  "lab.shareOfUsage": "{{share}} of recent MongolGPT usage",
  "lab.usageTitle": "{{lab}} token usage",
  "lab.usageDescription": "Daily MongolGPT token volume over the last two months.",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | MongolGPT Data",
  "model.description":
    "View {{model}} MongolGPT usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. MongolGPT usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's MongolGPT usage",
  "model.ranked": "Ranked #{{rank}} across last week's MongolGPT usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No MongolGPT usage in the current data window.",
  ...
  "model.inputs": "Inputs",
  "model.overviewDescription": "Recent MongolGPT tokens, unique users, and market position.",
  "model.noSummaryTitle": "No usage summary",
  "model.noSummaryDescription": "This model has no MongolGPT usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Daily MongolGPT token volume over the recent two-month window.",
  ...
  "model.usersDescription": "Daily unique MongolGPT users over the recent two-month window.",
  ...
  "model.efficiencyDescription": "Cost, cache behavior, and average MongolGPT session shape.",
  ...
  "model.geoDescription": "MongolGPT model tokens used by country.",
  "model.noGeoTitle": "No geo data",
  "model.noGeoDescription": "No MongolGPT geo rows matched this model.",
  "model.worldMap": "World map of model token usage by country",
  "model.peersDescription": "Nearby models by recent MongolGPT token volume.",
