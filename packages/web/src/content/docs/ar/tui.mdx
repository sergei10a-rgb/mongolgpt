---
title: TUI
description: استخدام واجهة المستخدم TUI في MongolGPT.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر MongolGPT واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل MongolGPT إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة MongolGPT في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى MongolGPT. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من MongolGPT. _الأسماء المستعارة_: `/quit`, `/q`
...
هذا منفصل عن `mongolgpt.json`، الذي يضبط سلوك الخادم ووقت التشغيل.
...
- `leader_timeout` - يتحكم في مدة انتظار MongolGPT بعد الضغط على leader key. القيمة الافتراضية `2000`.
...
- `sound_pack` - sound pack ID المراد استخدامه. القيمة الافتراضية `mongolgpt.default`.
