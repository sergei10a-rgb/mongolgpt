...
Więcej informacji znajdziesz na stronie [mongolgpt-gitlab-auth](https://www.npmjs.com/package/mongolgpt-gitlab-auth).
...
Funkcja [Sesje](https://docs.helicone.ai/features/sessions) firmy Helicone umożliwia grupowanie powiązanych żądań LLM. Użyj wtyczki [mongolgpt-helicone-session](https://github.com/H2Shami/mongolgpt-helicone-session), aby automatycznie rejestrować każdą konwersację mongolgpt jako sesję w Helicone.
