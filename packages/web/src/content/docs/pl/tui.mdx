---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala mongolgpt.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

mongolgpt zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie mongolgpt uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI mongolgpt, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do mongolgpt. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij mongolgpt. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `mongolgpt.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo MongolGPT czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `mongolgpt.default`.
