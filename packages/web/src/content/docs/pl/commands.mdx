...
Utwórz `.mongolgpt/commands/test.md`:
...
Możesz zdefiniować polecenia w `mongolgpt.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji mongolgpt:
...
- Globalnie: `~/.config/mongolgpt/commands/`
- Na projekt: `.mongolgpt/commands/`
...
mongolgpt zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
