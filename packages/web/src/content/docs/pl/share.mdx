---
title: Udostępnianie
description: Udostępnij swoje rozmowy dotyczące mongolgpt.
---

Funkcja udostępniania mongolgpt umożliwia tworzenie publicznych linków do konwersacji mongolgpt, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.
...
Kiedy udostępniasz rozmowę, mongolgpt:

1. Tworzy unikalny publiczny adres URL sesji
2. Synchronizuje historię rozmów z naszymi serwerami
3. Udostępnia rozmowę za pośrednictwem łącza do udostępniania — `mongolgpt.duckdns.org/s/<share-id>`

---

## Udostępnianie

mongolgpt obsługuje trzy tryby udostępniania, które kontrolują sposób udostępniania rozmów:

---

### Ręczne (domyślne)

Domyślnie mongolgpt korzysta z ręcznego trybu udostępniania. Sesje nie są udostępniane automatycznie, ale możesz je udostępnić ręcznie za pomocą polecenia `/share`:
...
Aby wymusić to w całym zespole dla danego projektu, dodaj go do `mongolgpt.json` w swoim projekcie i sprawdź w Git.
...
[Dowiedz się więcej](/docs/enterprise) o używaniu mongolgpt w Twojej organizacji.
