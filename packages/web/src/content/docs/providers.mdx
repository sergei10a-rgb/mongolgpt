...
More documentation on [mongolgpt-gitlab-auth](https://www.npmjs.com/package/mongolgpt-gitlab-auth) homepage.
...
Helicone's [Sessions](https://docs.helicone.ai/features/sessions) feature lets you group related LLM requests together. Use the [mongolgpt-helicone-session](https://github.com/H2Shami/mongolgpt-helicone-session) plugin to automatically log each MongolGPT conversation as a session in Helicone.
