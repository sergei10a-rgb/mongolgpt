...
[mongolgpt-gitlab-auth](https://www.npmjs.com/package/mongolgpt-gitlab-auth) 홈페이지에 추가 문서가 있습니다.
...
Helicone의 [Sessions](https://docs.helicone.ai/features/sessions) 기능을 사용하면 관련 LLM 요청을 그룹화할 수 있습니다. [mongolgpt-helicone-session](https://github.com/H2Shami/mongolgpt-helicone-session) 플러그인을 사용하여 각 MongolGPT 대화를 Helicone 세션으로 자동 기록하십시오.
