---
title: Condivisione
description: Condividi le tue conversazioni MongolGPT.
---

La funzione di condivisione di MongolGPT ti permette di creare link pubblici alle tue conversazioni, cosi puoi collaborare con i colleghi o chiedere aiuto ad altre persone.
...
Quando condividi una conversazione, MongolGPT:

1. Crea un URL pubblico univoco per la sessione
2. Sincronizza la cronologia della conversazione sui nostri server
3. Rende la conversazione accessibile tramite il link condivisibile: `mongolgpt.duckdns.org/s/<share-id>`

---

## Condivisione

MongolGPT supporta tre modalita di condivisione che controllano come vengono condivise le conversazioni:

---

### Manuale (predefinito)

Per impostazione predefinita, MongolGPT usa la condivisione manuale. Le sessioni non vengono condivise automaticamente, ma puoi condividerle manualmente con il comando `/share`:
...
Per applicarlo al tuo team in un progetto specifico, aggiungilo a `mongolgpt.json` nel progetto e versionalo su Git.
...
[Scopri di piu](/docs/enterprise) su come usare mongolgpt nella tua organizzazione.
