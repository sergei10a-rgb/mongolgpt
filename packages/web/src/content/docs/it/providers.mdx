...
Maggior documentazione sulla homepage di [mongolgpt-gitlab-auth](https://www.npmjs.com/package/mongolgpt-gitlab-auth).
...
La funzionalità [Sessions](https://docs.helicone.ai/features/sessions) di Helicone ti permette di raggruppare richieste LLM correlate. Usa il plugin [mongolgpt-helicone-session](https://github.com/H2Shami/mongolgpt-helicone-session) per loggare automaticamente ogni conversazione di MongolGPT come una sessione in Helicone.
