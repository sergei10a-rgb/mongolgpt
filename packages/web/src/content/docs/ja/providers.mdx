...
詳細については、[mongolgpt-gitlab-auth](https://www.npmjs.com/package/mongolgpt-gitlab-auth) ホームページ。
...
Helicone の [Sessions](https://docs.helicone.ai/features/sessions) 機能を使用すると、関連する LLM リクエストをグループ化できます。 [mongolgpt-helicone-session](https://github.com/H2Shami/mongolgpt-helicone-session) プラグインを使用して、各 MongolGPT 会話を Helicone のセッションとして自動的に記録します。
