...
Дополнительная документация на домашней странице [mongolgpt-gitlab-auth](https://www.npmjs.com/package/mongolgpt-gitlab-auth).
...
Функция Helicone [Sessions](https://docs.helicone.ai/features/sessions) позволяет группировать связанные запросы LLM вместе. Используйте плагин [mongolgpt-helicone-session](https://github.com/H2Shami/mongolgpt-helicone-session), чтобы автоматически регистрировать каждый диалог mongolgpt как сеанс в Helicone.
