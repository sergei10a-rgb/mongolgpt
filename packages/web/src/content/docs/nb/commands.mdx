...
Opprett `.mongolgpt/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom MongolGPT-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i MongolGPT [config](/docs/config):
...
- Per prosjekt: `.mongolgpt/commands/`
...
MongolGPT inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
