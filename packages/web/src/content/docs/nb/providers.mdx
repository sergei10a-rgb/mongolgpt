...
Mer dokumentasjon på [mongolgpt-gitlab-auth](https://www.npmjs.com/package/mongolgpt-gitlab-auth) hjemmeside.
...
Helicones [Sessions](https://docs.helicone.ai/features/sessions) funksjon lar deg gruppere relaterte LLM forespørsler sammen. Bruk [mongolgpt-helicone-session](https://github.com/H2Shami/mongolgpt-helicone-session) plugin for automatisk å logge hver MongolGPT-samtale som en økt i Helicone.
