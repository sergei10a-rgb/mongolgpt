...
更多文件請參閱 [mongolgpt-gitlab-auth](https://www.npmjs.com/package/mongolgpt-gitlab-auth) 首頁。
...
Helicone 的 [Sessions](https://docs.helicone.ai/features/sessions) 功能允許您將相關的 LLM 請求歸為一組。使用 [mongolgpt-helicone-session](https://github.com/H2Shami/mongolgpt-helicone-session) 外掛可以自動將每個 MongolGPT 對話記錄為 Helicone 中的一個工作階段。
