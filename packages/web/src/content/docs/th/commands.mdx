...
สร้าง `.mongolgpt/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ MongolGPT:
...
- ระดับผู้ใช้ (Global): `~/.config/mongolgpt/commands/`
- ระดับโปรเจ็กต์: `.mongolgpt/commands/`
...
MongolGPT มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
