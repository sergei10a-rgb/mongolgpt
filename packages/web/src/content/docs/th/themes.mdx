...
ด้วย MongolGPT คุณสามารถเลือกจากหนึ่งในธีมที่มีอยู่แล้วภายใน ใช้ธีมที่ปรับให้เข้ากับธีม terminal ของคุณ หรือกำหนดธีมที่คุณกำหนดเองได้

ตามค่าเริ่มต้น MongolGPT จะใช้ธีม `mongolgpt` ของเราเอง
...
MongolGPT มาพร้อมกับธีมในตัวหลายธีม
...
|
ord`                 | อิงตามธีม [Nord](https://github.com/nordtheme/nord)                 |
...
- **รักษาค่าเริ่มต้นของ terminal**: ใช้
one` สำหรับสีข้อความและพื้นหลัง เพื่อรักษารูปลักษณ์ดั้งเดิมของ terminal ของคุณ

ธีมของระบบมีไว้สำหรับผู้ใช้ที่:

- ต้องการให้ MongolGPT ตรงกับรูปลักษณ์ของ terminal
...
MongolGPT รองรับระบบธีมที่ใช้ JSON ที่ยืดหยุ่น ซึ่งช่วยให้ผู้ใช้สามารถสร้างและปรับแต่งธีมได้อย่างง่ายดาย
...
2. **ไดเรกทอรีกำหนดค่าผู้ใช้** - กำหนดใน `~/.config/mongolgpt/themes/*.json` หรือ `$XDG_CONFIG_HOME/mongolgpt/themes/*.json`
3. **ไดเรกทอรีรากของโครงการ** - กำหนดไว้ใน `<project-root>/.mongolgpt/themes/*.json`
4. **ไดเร็กทอรีการทำงานปัจจุบัน** - กำหนดใน `./.mongolgpt/themes/*.json`
