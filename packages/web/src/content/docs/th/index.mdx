...
วิธีที่ง่ายที่สุดในการติดตั้ง MongolGPT คือการใช้สคริปต์การติดตั้ง
...
- **ใช้ Homebrew บน macOS และ Linux**
  ...
  > เราขอแนะนำให้ใช้ MongolGPT tap เพื่อเผยแพร่ข้อมูลล่าสุด สูตร `brew install mongolgpt` อย่างเป็นทางการได้รับการดูแลโดยทีมงาน Homebrew และมีการอัปเดตไม่บ่อยนัก
...
:::tip[แนะนำ: ใช้ WSL]
เพื่อประสบการณ์ที่ดีที่สุดบน Windows เราขอแนะนำให้ใช้ [ระบบย่อย Windows สำหรับ Linux (WSL)](/docs/windows-wsl) ให้ประสิทธิภาพที่ดีขึ้นและความเข้ากันได้เต็มรูปแบบกับคุณสมบัติของ MongolGPT
:::
...
ขณะนี้การสนับสนุนสำหรับการติดตั้ง MongolGPT บน Windows โดยใช้ Bun อยู่ระหว่างดำเนินการ

คุณยังสามารถคว้าไบนารี่ได้จาก [เผยแพร่](https://github.com/sergei10a-rgb/mongolgpt/releases)
