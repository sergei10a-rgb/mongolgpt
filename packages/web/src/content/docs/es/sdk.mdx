---
title: SDK
description: Cliente JS con seguridad de tipos para el servidor mongolgpt.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

El SDK mongolgpt JS/TS proporciona un cliente con seguridad de tipos para interactuar con el servidor.
Úselo para crear integraciones y controlar mongolgpt mediante programación.
...
Cree una instancia de mongolgpt:
...
| `port`     |
umber`      | Puerto del servidor                             | `4096`         |
| `signal`   | `AbortSignal` | Señal de aborto para cancelación                | `undefined`    |
| `timeout`  |
umber`      | Tiempo de espera en ms para inicio del servidor | `5000`         |
...
Puede pasar un objeto de configuración para personalizar el comportamiento. La instancia aún recoge su `mongolgpt.json`, pero puede anular o agregar configuración en línea:
...
Si ya tiene una instancia en ejecución de mongolgpt, puede crear una instancia de cliente para conectarse a ella:
...
| `retryCount` |
umber`        | Opcional. Número de reintentos de validación (predeterminado: 2) |
