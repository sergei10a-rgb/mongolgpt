...
Más documentación en la página de inicio de [mongolgpt-gitlab-auth](https://www.npmjs.com/package/mongolgpt-gitlab-auth).
...
La función [Sesiones](https://docs.helicone.ai/features/sessions) de Helicone le permite agrupar solicitudes LLM relacionadas. Utilice el complemento [mongolgpt-helicone-session](https://github.com/H2Shami/mongolgpt-helicone-session) para registrar automáticamente cada conversación MongolGPT como una sesión en Helicone.
