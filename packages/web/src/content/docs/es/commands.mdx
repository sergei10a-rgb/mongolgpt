...
Crear `.mongolgpt/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración MongolGPT o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su MongolGPT [config](/docs/config):
...
- Por proyecto: `.mongolgpt/commands/`
...
mongolgpt incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
