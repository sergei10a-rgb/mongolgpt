...
Weitere Dokumentation auf der [mongolgpt-gitlab-auth](https://www.npmjs.com/package/mongolgpt-gitlab-auth)-Homepage.
...
Mit der [Sessions](https://docs.helicone.ai/features/sessions)-Funktion von Helicone können Sie zusammengehörige LLM-Anfragen gruppieren. Verwenden Sie das [mongolgpt-helicone-session](https://github.com/H2Shami/mongolgpt-helicone-session)-Plugin, um jede MongolGPT-Konversation automatisch als Sitzung in Helicone zu protokollieren.
