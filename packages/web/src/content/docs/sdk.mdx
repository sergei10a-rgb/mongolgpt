---
title: SDK
description: Type-safe JS client for mongolgpt server.
---

import config from "../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

The mongolgpt JS/TS SDK provides a type-safe client for interacting with the server.
Use it to build integrations and control mongolgpt programmatically.
...
Create an instance of mongolgpt:
...
| `port`     |
umber`      | Server port                    | `4096`      |
| `signal`   | `AbortSignal` | Abort signal for cancellation  | `undefined` |
| `timeout`  |
umber`      | Timeout in ms for server start | `5000`      |
...
You can pass a configuration object to customize behavior. The instance still picks up your `mongolgpt.json`, but you can override or add configuration inline:
...
If you already have a running instance of mongolgpt, you can create a client instance to connect to it:
...
| `retryCount` |
umber`        | Optional. Number of validation retries (default: 2)        |
