...
description: mongolgpt dile özgü biçimlendiriciler kullanır.
---

mongolgpt, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

mongolgpt, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, mongolgpt bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

mongolgpt bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri mongolgpt yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
