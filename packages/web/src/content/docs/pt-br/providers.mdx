...
Mais documentação na página [mongolgpt-gitlab-auth](https://www.npmjs.com/package/mongolgpt-gitlab-auth).
...
O recurso [Sessões](https://docs.helicone.ai/features/sessions) do Helicone permite que você agrupe solicitações LLM relacionadas. Use o plugin [mongolgpt-helicone-session](https://github.com/H2Shami/mongolgpt-helicone-session) para registrar automaticamente cada conversa do mongolgpt como uma sessão no Helicone.
