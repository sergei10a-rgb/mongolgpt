---
title: Compartilhar
description: Compartilhe suas conversas do mongolgpt.
---

O recurso de compartilhamento do mongolgpt permite que você crie links públicos para suas conversas do mongolgpt, para que você possa colaborar com colegas de equipe ou obter ajuda de outros.
...
Quando você compartilha uma conversa, o mongolgpt:

1. Cria uma URL pública única para sua sessão
2. Sincroniza seu histórico de conversas com nossos servidores
3. Torna a conversa acessível através do link compartilhável — `mongolgpt.duckdns.org/s/<share-id>`

---

## Compartilhamento

O mongolgpt suporta três modos de compartilhamento que controlam como as conversas são compartilhadas:

---

### Manual (padrão)

Por padrão, o mongolgpt usa o modo de compartilhamento manual. As sessões não são compartilhadas automaticamente, mas você pode compartilhá-las manualmente usando o comando `/share`:
...
Para impor isso em sua equipe para um determinado projeto, adicione-o ao `mongolgpt.json` em seu projeto e faça o check-in no Git.
...
[Saiba mais](/docs/enterprise) sobre como usar o mongolgpt em sua organização.
