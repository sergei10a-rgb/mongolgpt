---
title: IDE
description: The MongolGPT extension for VS Code, Cursor, and other IDEs
---

MongolGPT integrates with VS Code, Cursor, or any IDE that supports a terminal. Just run `mongolgpt` in the terminal to get started.
...
To install MongolGPT on VS Code and popular forks like Cursor, Windsurf, VSCodium:

1. Open VS Code
2. Open the integrated terminal
3. Run `mongolgpt` - the extension installs automatically
...
Search for **MongolGPT** in the Extension Marketplace and click **Install**.
...
- Ensure you’re running `mongolgpt` in the integrated terminal.
