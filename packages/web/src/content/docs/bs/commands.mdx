...
Kreiraj `.mongolgpt/commands/test.md`:
...
Možete dodati prilagođene komande kroz MongolGPT konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom MongolGPT [config](/docs/config):
...
- Globalno: `~/.config/mongolgpt/commands/`
- Po projektu: `.mongolgpt/commands/`
...
MongolGPT uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
