---
title: SDK
description: Type-safe JS klijent za mongolgpt server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

mongolgpt JS/TS SDK pruza type-safe klijent za interakciju sa serverom.
Koristite ga za izradu integracija i programsko upravljanje mongolgpt-om.
...
| `port`     |
umber`      | Port servera                  | `4096`      |
| `signal`   | `AbortSignal` | Abort signal za otkazivanje   | `undefined` |
| `timeout`  |
umber`      | Timeout u ms za start servera | `5000`      |
...
Mozete proslijediti konfiguracijski objekat za prilagodavanje ponasanja. Instanca i dalje ucitava `mongolgpt.json`, ali konfiguraciju mozete nadjacati ili dodati inline:
...
Ako vec imate pokrenutu mongolgpt instancu, mozete napraviti klijentsku instancu i povezati se na nju:
...
| `retryCount` |
umber`        | Opcionalno. Broj ponovnih pokušaja validacije (default: 2)  |
