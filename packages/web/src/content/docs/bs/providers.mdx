...
Više dokumentacije na početnoj stranici [mongolgpt-gitlab-auth](https://www.npmjs.com/package/mongolgpt-gitlab-auth).
...
Heliconeova funkcija [Sessions](https://docs.helicone.ai/features/sessions) vam omogućava da grupišete povezane LLM zahtjeve zajedno. Koristite dodatak [mongolgpt-helicone-session](https://github.com/H2Shami/mongolgpt-helicone-session) da automatski prijavite svaki MongolGPT razgovor kao sesiju u Helicone-u.
