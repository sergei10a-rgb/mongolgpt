...
Mere dokumentation på [mongolgpt-gitlab-auth](https://www.npmjs.com/package/mongolgpt-gitlab-auth) hjemmesiden.
...
Helicones [Sessions](https://docs.helicone.ai/features/sessions) funktion lader dig gruppe relaterede LLM anmodninger sammen. Brug [mongolgpt-helicone-session](https://github.com/H2Shami/mongolgpt-helicone-session) plugin for automatisk at logge hver MongolGPT-samtale som en session i Helicone.
