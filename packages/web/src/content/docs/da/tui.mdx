---
title: TUI
description: Brug af MongolGPT-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

MongolGPT giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre MongolGPT starter TUI for den nuværende mappe.
...
Når du bruger MongolGPT TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til MongolGPT. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut MongolGPT. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `mongolgpt.json`, som konfigurerer server-/kørselstidsadfærd.
...
- `leader_timeout` - Styrer hvor længe MongolGPT venter efter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID der skal bruges. Standard er `mongolgpt.default`.
