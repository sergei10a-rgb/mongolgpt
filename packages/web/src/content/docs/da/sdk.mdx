...
Brug den til at bygge integrasjoner og kontrollere mongolgpt programmatisk.
...
Opret en forekomst av mongolgpt:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `mongolgpt.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av mongolgpt, kan du oprete en klientforekomst for at koble til den:
...
| `retryCount` |
umber`        | Valgfri. Antal valideringsforsøg (standard: 2)             |
