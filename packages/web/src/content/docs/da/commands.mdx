...
Opret `.mongolgpt/commands/test.md`:
...
Du kan tilføje brugerdefinerede kommandoer gennem MongolGPT-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din MongolGPT [config](/docs/config):
...
- Globalt: `~/.config/mongolgpt/commands/`
- Pr. projekt: `.mongolgpt/commands/`
...
mongolgpt indeholder flere indbyggede kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
