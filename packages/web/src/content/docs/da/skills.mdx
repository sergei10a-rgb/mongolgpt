...
Agentferdigheter lar MongolGPT oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går MongolGPT opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
MongolGPT viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `mongolgpt.json`:
...
2. Tjek at frontmatter inkluderer
ame` og `description`
