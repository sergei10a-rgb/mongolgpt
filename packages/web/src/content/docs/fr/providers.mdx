...
Plus de documentation sur la page d'accueil [mongolgpt-gitlab-auth](https://www.npmjs.com/package/mongolgpt-gitlab-auth).
...
La fonctionnalité [Sessions](https://docs.helicone.ai/features/sessions) d'Helicone vous permet de regrouper les requêtes LLM associées. Utilisez le plugin [mongolgpt-helicone-session](https://github.com/H2Shami/mongolgpt-helicone-session) pour enregistrer automatiquement chaque conversation MongolGPT en tant que session dans Helicone.
