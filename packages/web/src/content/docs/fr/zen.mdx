---
title: Zen
description: Liste organisée de modèles fournis par MongolGPT.
---
...
MongolGPT Zen est une liste de modèles testés et vérifiés fournie par l'équipe MongolGPT.

Zen fonctionne comme n'importe quel autre fournisseur dans MongolGPT. Vous vous connectez à MongolGPT Zen et obtenez votre clé API. C'est **entièrement facultatif** et vous n'avez pas besoin de l'utiliser pour utiliser MongolGPT.
...
:::tip
Nous avons testé un groupe sélectionné de modèles et de fournisseurs qui fonctionnent bien avec MongolGPT.
:::
...
MongolGPT Zen est une passerelle AI qui vous donne accès à ces modèles.

---

## Comment ça marche

MongolGPT Zen fonctionne comme n'importe quel autre fournisseur dans MongolGPT.

1. Vous vous connectez à **<a href={console}>MongolGPT Zen</a>**, ajoutez vos informations de facturation et copiez votre clé API.
2. Vous exécutez la commande `/connect` dans le TUI, sélectionnez MongolGPT Zen et collez votre clé API.
...
| GPT 5.4 Mini           | gpt-5.4-mini           | `https://mongolgpt.duckdns.org/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5.4 Nano           | gpt-5.4-nano           | `https://mongolgpt.duckdns.org/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5.3 Codex          | gpt-5.3-codex          | `https://mongolgpt.duckdns.org/zen/v1/responses`               | `@ai-sdk/openai`            |
...
| GPT 5.2 Codex          | gpt-5.2-codex          | `https://mongolgpt.duckdns.org/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5.1                | gpt-5.1                | `https://mongolgpt.duckdns.org/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5.1 Codex          | gpt-5.1-codex          | `https://mongolgpt.duckdns.org/zen/v1/responses`               | `@ai-sdk/openai`            |
...
| GPT 5 Codex            | gpt-5-codex            | `https://mongolgpt.duckdns.org/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5 Nano             | gpt-5-nano             | `https://mongolgpt.duckdns.org/zen/v1/responses`               | `@ai-sdk/openai`            |
| Claude Fable 5         | claude-fable-5         | `https://mongolgpt.duckdns.org/zen/v1/messages`                | `@ai-sdk/anthropic`         |
...
| Claude Haiku 4.5       | claude-haiku-4-5       | `https://mongolgpt.duckdns.org/zen/v1/messages`                | `@ai-sdk/anthropic`         |
| Claude Haiku 3.5       | claude-3-5-haiku       | `https://mongolgpt.duckdns.org/zen/v1/messages`                | `@ai-sdk/anthropic`         |
| Gemini 3.5 Flash       | gemini-3.5-flash       | `https://mongolgpt.duckdns.org/zen/v1/models/gemini-3.5-flash` | `@ai-sdk/google`            |
| Gemini 3.1 Pro         | gemini-3.1-pro         | `https://mongolgpt.duckdns.org/zen/v1/models/gemini-3.1-pro`   | `@ai-sdk/google`            |
| Gemini 3 Flash         | gemini-3-flash         | `https://mongolgpt.duckdns.org/zen/v1/models/gemini-3-flash`   | `@ai-sdk/google`            |
| Qwen3.7 Max            | qwen3.7-max            | `https://mongolgpt.duckdns.org/zen/v1/messages`                | `@ai-sdk/anthropic`         |
| Qwen3.7 Plus           | qwen3.7-plus           | `https://mongolgpt.duckdns.org/zen/v1/messages`                | `@ai-sdk/anthropic`         |
| Qwen3.6 Plus           | qwen3.6-plus           | `https://mongolgpt.duckdns.org/zen/v1/messages`                | `@ai-sdk/anthropic`         |
| Qwen3.5 Plus           | qwen3.5-plus           | `https://mongolgpt.duckdns.org/zen/v1/messages`                | `@ai-sdk/anthropic`         |
...
| MiniMax M2.7           | minimax-m2.7           | `https://mongolgpt.duckdns.org/zen/v1/chat/completions`        | `@ai-sdk/openai-compatible` |
| MiniMax M2.5           | minimax-m2.5           | `https://mongolgpt.duckdns.org/zen/v1/chat/completions`        | `@ai-sdk/openai-compatible` |
...
| Big Pickle             | big-pickle             | `https://mongolgpt.duckdns.org/zen/v1/chat/completions`        | `@ai-sdk/openai-compatible` |
| MiMo-V2.5 Free         | mimo-v2.5-free         | `https://mongolgpt.duckdns.org/zen/v1/chat/completions`        | `@ai-sdk/openai-compatible` |
| North Mini Code Free   | north-mini-code-free   | `https://mongolgpt.duckdns.org/zen/v1/chat/completions`        | `@ai-sdk/openai-compatible` |
...
Le [model id](/docs/config/#models) dans votre configuration MongolGPT utilise le format `mongolgpt/<model-id>`. Par exemple, pour GPT 5.5, vous utiliseriez `mongolgpt/gpt-5.5` dans votre configuration.
...
- DeepSeek V4 Flash Free est disponible sur MongolGPT pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- MiMo-V2.5 Free est disponible sur MongolGPT pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- North Mini Code Free est disponible sur MongolGPT pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- Nemotron 3 Ultra Free est disponible sur MongolGPT pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- Big Pickle est un modèle stealth gratuit sur MongolGPT pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
...
Nous avons créé MongolGPT Zen pour :
...
4. N'avoir **aucun lock-in** en vous permettant de l'utiliser avec n'importe quel autre agent de codage. Et toujours vous permettre d'utiliser n'importe quel autre fournisseur avec MongolGPT également.
