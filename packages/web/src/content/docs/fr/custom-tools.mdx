...
description: Créez des outils que le LLM peut appeler dans mongolgpt.
---

Les outils personnalisés sont des fonctions que vous créez et que le LLM peut appeler pendant les conversations. Ils fonctionnent avec les [outils intégrés](/docs/tools) de mongolgpt comme `read`, `write` et `bash`.
...
- Localement en les plaçant dans le répertoire `.mongolgpt/tools/` de votre projet.
- Ou globalement, en les plaçant dans `~/.config/mongolgpt/tools/`.
