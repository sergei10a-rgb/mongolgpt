...
import { IconMongolGPT } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "mongolgpt/session/message-v2"
import type { Message } from "mongolgpt/session/message"
import type { Session } from "mongolgpt/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.mongolgpt_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.mongolgpt_name}>
                    <IconMongolGPT width={16} height={16} />
                  </div>
