...
const emptyList = new Set(["/skill", "/command", "/lsp", "/formatter", "/vcs/status", "/vcs/diff", "/file"])
...
export async function mockMongolGPTServer(page: Page, config: MockServerConfig) {
