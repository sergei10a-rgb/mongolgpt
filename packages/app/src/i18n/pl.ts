export const dict = {
  ...
  "dialog.provider.mongolgpt.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.mongolgpt.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.mongolgptGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez MongolGPT",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w MongolGPT.",
  ...
  "provider.connect.mongolgptZen.line1":
    "MongolGPT Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.mongolgptZen.visit.prefix": "Odwiedź ",
  "provider.connect.mongolgptZen.visit.link": "mongolgpt.duckdns.org/zen",
  "provider.connect.mongolgptZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w MongolGPT.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w MongolGPT.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w mongolgpt.json",
  ...
  "dialog.server.description": "Przełącz serwer MongolGPT, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja MongolGPT ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu MongolGPT",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (mongolgpt.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "MongolGPT zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla MongolGPT",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd MongolGPT na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy MongolGPT ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw MongolGPT.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania MongolGPT",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji MongolGPT.",
