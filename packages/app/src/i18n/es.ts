export const dict = {
  ...
  "dialog.provider.mongolgpt.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.mongolgpt.tagline": "Modelos optimizados y fiables",
  "dialog.provider.mongolgptGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por MongolGPT",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en MongolGPT.",
  ...
  "provider.connect.mongolgptZen.line1":
    "MongolGPT Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.mongolgptZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.mongolgptZen.visit.prefix": "Visita ",
  ...
  "provider.connect.mongolgptZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en MongolGPT.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en MongolGPT.",
  ...
  "dialog.plugins.empty": "Plugins configurados en mongolgpt.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de MongolGPT se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de MongolGPT ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de MongolGPT",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (mongolgpt.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, MongolGPT no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "MongolGPT incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor MongolGPT dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para MongolGPT",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve MongolGPT en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si MongolGPT sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de MongolGPT.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia MongolGPT",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de MongolGPT.",
