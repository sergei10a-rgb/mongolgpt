...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "MongolGPT tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve MongolGPT'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.mongolgptAccount.line1":
    "MongolGPT, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.mongolgptAccount.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak MongolGPT'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler mongolgpt.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi MongolGPT sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "MongolGPT'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı MongolGPT ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (mongolgpt.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: MongolGPT henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "MongolGPT ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "MongolGPT Masaüstü",
  ...
  "settings.desktop.wsl.description": "MongolGPT sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "MongolGPT'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "MongolGPT'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "MongolGPT'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "MongolGPT'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "MongolGPT başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "MongolGPT'un en son sürümünü kullanıyorsunuz.",
