export const dict = {
  ...
  "dialog.provider.mongolgpt.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.mongolgpt.tagline": "Pålidelige optimerede modeller",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af MongolGPT",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i MongolGPT.",
  ...
  "provider.connect.mongolgptAccount.line1":
    "MongolGPT giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.mongolgptAccount.visit.prefix": "Besøg ",
  ...
  "provider.connect.mongolgptAccount.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i MongolGPT.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i MongolGPT.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i mongolgpt.json",
  ...
  "dialog.server.description": "Skift hvilken MongolGPT-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af MongolGPT ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til MongolGPT-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (mongolgpt.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, MongolGPT understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "MongolGPT inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør MongolGPT-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for MongolGPT",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan MongolGPT ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om MongolGPT følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan MongolGPT er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når MongolGPT starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af MongolGPT.",
