export const dict = {
  ...
  "settings.account.usage": "{{requests}} requests · {{tokens}} tokens",
  "settings.account.limit.free": "Daily limit: {{primary}} primary and {{fallback}} fallback requests",
  "settings.account.limit.paid": "Weekly token limit: {{tokens}}",
  "settings.account.quota.available": "Weekly usage: {{used}} / {{limit}} tokens",
  "settings.account.quota.weeklyCost": "Weekly cost limit used: {{percent}}",
  "settings.account.quota.rollingCost": "{{hours}}-hour cost limit used: {{percent}}",
  ...
  "settings.account.quota.resetAt": "Resets: {{date}}",
