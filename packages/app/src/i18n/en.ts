export const dict = {
  ...
  "onboarding.workspace.description":
    "Choose the MongolGPT workspace used for Free Auto usage, plan, and quota accounting.",
  ...
  "sidebar.gettingStarted.line1": "Free Auto becomes available at no cost after you sign in to your MongolGPT account.",
