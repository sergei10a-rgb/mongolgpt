export const dict = {
  ...
  "command.logs.export": "Export diagnostic logs",
  ...
  "agent.builtin.build": "Build",
  "agent.builtin.plan": "Plan",
  "agent.builtin.general": "General",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by MongolGPT",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in MongolGPT.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in MongolGPT.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in MongolGPT.",
  ...
  "provider.custom.presets.label": "Quick setup",
  "provider.custom.presets.description": "Choose a local runtime, then enter the model ID currently loaded in it.",
  "provider.custom.presets.ollama": "Use Ollama settings",
  "provider.custom.presets.lmStudio": "Use LM Studio settings",
  ...
  "onboarding.account.loggingIn": "Signing in through your browser...",
  "onboarding.account.loginError": "Sign-in did not finish. Check your connection and try again.",
  "onboarding.account.statusError": "Could not check your account status. Restart MongolGPT or try again.",
  "onboarding.account.retry": "Check again",
  "onboarding.account.retrying": "Checking...",
  "onboarding.account.syncError": "Your account is connected, but model access could not be refreshed.",
  "onboarding.account.syncRetry": "Refresh model access",
  "onboarding.account.syncing": "Refreshing...",
  "onboarding.workspace.heading": "Choose a workspace",
  "onboarding.workspace.description": "Choose the MongolGPT workspace for your plan and account usage.",
  "onboarding.workspace.loading": "Loading workspaces...",
  "onboarding.workspace.loadError": "Could not load your workspaces.",
  "onboarding.workspace.empty": "This account has no available workspace.",
  "onboarding.workspace.select": "Select",
  "onboarding.workspace.selecting": "Activating...",
  "onboarding.workspace.selectError": "Could not activate the workspace. Try again.",
  "onboarding.providers.heading": "Choose how to start",
  "onboarding.providers.description": "Providers using your own key and local model connections are optional.",
  "onboarding.providers.freeAuto.title": "MongolGPT free models",
  "onboarding.providers.freeAuto.description": "Available free models and usage limits are set by the provider.",
  ...
  "onboarding.providers.continue": "Continue",
  ...
  "prompt.bootstrap.loading.agent": "Loading agent options...",
  "prompt.bootstrap.loading.directory-models": "Loading project models...",
  "prompt.bootstrap.loading.server-models": "Loading server models...",
  "prompt.bootstrap.error.agent": "Agent options could not be loaded.",
  "prompt.bootstrap.error.directory-models": "Project models could not be loaded.",
  "prompt.bootstrap.error.server-models": "Server models could not be loaded.",
  "prompt.bootstrap.timeout.agent": "Agent options are taking too long to load.",
  "prompt.bootstrap.timeout.directory-models": "Project models are taking too long to load.",
  "prompt.bootstrap.timeout.server-models": "Server models are taking too long to load.",
  "prompt.bootstrap.retry": "Retry",
  ...
  "dialog.plugins.empty": "Plugins configured in mongolgpt.json",
  ...
  "dialog.server.bridge.name": "MongolGPT Desktop",
  "dialog.server.bridge.button": "Connect MongolGPT Desktop",
  "dialog.server.bridge.connecting": "Opening Desktop...",
  "dialog.server.bridge.accountRequired": "Sign in to your MongolGPT account before connecting Desktop.",
  "dialog.server.bridge.accountMismatch": "The Desktop and Web accounts do not match.",
  "dialog.server.bridge.expired": "The Desktop connection has expired. Connect again.",
  "dialog.server.bridge.started.title": "Desktop connection started",
  "dialog.server.bridge.started.description": "Approve the connection in MongolGPT Desktop, then return here.",
  "dialog.server.bridge.connected.title": "Desktop connected",
  "dialog.server.bridge.connected.description": "You can now use local projects and models from this Web app.",
  "dialog.server.bridge.failed.title": "Could not connect Desktop",
  "dialog.server.bridge.failed.description": "Open MongolGPT Desktop and try again.",
  ...
  "wsl.onboarding.checkingMongolGPT": "Checking MongolGPT...",
  "wsl.onboarding.checkingMongolGPTIn": "Checking MongolGPT in {{distro}}...",
  "wsl.onboarding.updatingMongolGPT": "Updating MongolGPT...",
  "wsl.onboarding.updatingMongolGPTIn": "Updating MongolGPT in {{distro}}...",
  "wsl.onboarding.updateMongolGPTIn": "Update MongolGPT in {{distro}}.",
  "wsl.onboarding.updateMongolGPT": "Update MongolGPT",
  "wsl.onboarding.mongolgptReadyIn": "MongolGPT is ready in {{distro}}.",
  "wsl.onboarding.mongolgptReady": "MongolGPT is ready.",
  "wsl.onboarding.installMongolGPTIn": "Install MongolGPT in {{distro}}.",
  "wsl.onboarding.installMongolGPT": "Install MongolGPT",
  ...
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen MongolGPT.",
  ...
  "toast.update.description": "A new version of MongolGPT ({{version}}) is now available to install.",
  ...
  "home.project.openCloud": "Open cloud workspace",
  ...
  "home.sessions.empty.noProject.description": "Open a project to get started",
  "home.sessions.empty.noProject.webDescription": "Open a cloud workspace or connect the desktop app to get started",
  ...
  "sidebar.gettingStarted.line1": "Available free models appear in the model list.",
  ...
  "settings.account.signedOutDescription": "Sign in with the same account and workspace access across clients.",
  ...
  "settings.account.overview": "Plan and usage",
  "settings.account.overviewLoading": "Loading plan and usage...",
  "settings.account.overviewLoadingDescription": "Reading plan, limits, and usage for your workspaces.",
  "settings.account.overviewLoadError": "Could not load plan and usage",
  "settings.account.overviewLoadErrorDescription": "Reconnect to the account service and try again.",
  "settings.account.noWorkspaces": "No workspaces found",
  "settings.account.noWorkspacesDescription": "This account does not currently have a visible workspace.",
  "settings.account.currentWorkspace": "Current",
  "settings.account.workspaceSwitch": "Activate",
  "settings.account.workspaceSwitching": "Switching...",
  "settings.account.workspaceSwitchError": "Could not switch workspaces. Try again.",
  ...
  "settings.account.role.member": "Member",
  "settings.account.period.week": "This week",
  "settings.account.period.subscription": "Current subscription period",
  "settings.account.workspaceMeta": "{{role}} · {{period}}",
  "settings.account.usage": "Workspace usage: {{requests}} requests · {{tokens}} tokens",
  "settings.account.limit.free": "Daily limit: {{primary}} primary and {{fallback}} fallback requests",
  "settings.account.limit.paid":
    "Weekly: {{weeklyTokens}} tokens, {{weeklyRequests}} requests; monthly: {{monthlyTokens}} tokens, {{monthlyRequests}} requests",
  "settings.account.quota.available": "Your weekly tokens: {{used}} / {{limit}}",
  "settings.account.quota.weeklyCost": "Your weekly cost limit used: {{percent}}",
  "settings.account.quota.weeklyRequests": "Your weekly requests: {{used}} / {{limit}}",
  "settings.account.quota.monthlyTokens": "Your monthly tokens: {{used}} / {{limit}}",
  ...
  "settings.account.quota.modelScoped": "Usage limits are counted per model.",
  ...
  "settings.desktop.wsl.description": "Run the MongolGPT server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for MongolGPT",
  ...
  "settings.general.row.appearance.description": "Customise how MongolGPT looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether MongolGPT follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how MongolGPT is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when MongolGPT launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of MongolGPT.",
  ...
  "settings.imports.title": "Integration",
  "settings.imports.section.title": "Automatic matching",
  "settings.imports.type.auto": "Automatic",
  "settings.imports.type.auto.description": "Let MongolGPT identify whether the source is MCP, a skill, or a plugin",
  "settings.imports.type.mcp.description": "An MCP server from Claude, Cursor, Codex, Goose, or another client",
  "settings.imports.type.skill.description": "A SKILL.md file, skill folder, or skill URL",
  "settings.imports.type.plugin.description": "A JS/TS plugin package or local plugin folder",
  "settings.imports.type.skill": "Skill",
  "settings.imports.type.plugin": "Plugin",
  "settings.imports.scope.global": "All projects",
  "settings.imports.scope.global.description": "Add to the MongolGPT account's global local config",
  "settings.imports.scope.project": "Current project",
  "settings.imports.scope.project.description": "Add to the selected project's .mongolgpt config",
  "settings.imports.error.projectDirectoryRequired":
    "Project folder not found. Enter a folder when using project scope.",
  "settings.imports.toast.applied.title": "Integration added",
  "settings.imports.toast.applied.description": "{{count}} change(s) written to the config",
  "settings.imports.adapter": "Plugin adapter",
  "settings.imports.environment": "Environment variables",
  "settings.imports.header": "Headers",
  "settings.imports.config": "Configuration",
  "settings.imports.operation.mcp": "MCP",
  "settings.imports.operation.server": "server",
  "settings.imports.operation.skillPath": "Skill path",
  "settings.imports.operation.skillUrl": "Skill URL",
  "settings.imports.operation.plugin": "Plugin",
  "settings.imports.outcome.add": "Add",
  "settings.imports.outcome.replace": "Replace",
  "settings.imports.outcome.noop": "No change",
}
