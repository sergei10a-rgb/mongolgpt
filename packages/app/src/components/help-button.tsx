import { Icon } from "@mongolgpt/ui/v2/icon"
import { Popover } from "@mongolgpt/ui/popover"
import { createSignal, Show } from "solid-js"
import { createStore } from "solid-js/store"

export function HelpButton() {
  if (import.meta.env.VITE_MONGOLGPT_CHANNEL !== "dev") return null
        ...
        >
          <Show when={shown()}>
            <div class="relative flex flex-col gap-1 w-[320px] p-4 rounded-xl bg-background-strong shadow-[var(--shadow-lg-border-base)]">
              ...
              <span class="text-14-regular text-text-strong">MongolGPT тусламж</span>
              <p class="text-12-regular text-text-weak">
                Асуудал гарвал лог экспортлоод, тохиргоо болон server холболтоо шалгаарай.
              </p>
            </div>
          </Show>
        </Popover>
