...
import { Tooltip, TooltipKeybind } from "@mongolgpt/ui/tooltip"
import { useTheme } from "@mongolgpt/ui/theme/context"
import { IconButtonV2 } from "@mongolgpt/ui/v2/icon-button-v2"
import { Icon as IconV2 } from "@mongolgpt/ui/v2/icon"
import { KeybindV2 } from "@mongolgpt/ui/v2/keybind-v2"
import { TooltipV2 } from "@mongolgpt/ui/v2/tooltip-v2"
...
export function Titlebar(props: { update?: TitlebarUpdate }) {
  ...
  const updateState = createMemo<TitlebarUpdatePillState>(() => {
    ...
    return {
      ...
      title: version ? language.t("error.page.action.updateTo", { version }) : undefined,
        ...
        <Match when>
          ...
          >
              ...
              <div class="flex items-center gap-1 shrink-0">
                ...
                <div class="hidden xl:flex items-center shrink-0">
                  ...
                  >
                    ...
                    <div id="mongolgpt-titlebar-left" class="flex items-center gap-3 min-w-0 px-2" />
                    <ChannelIndicator />
                  </div>
                </div>
              </div>
            ...
            <div
              ...
              onMouseDown={drag}
            >
              <div id="mongolgpt-titlebar-right" class="flex items-center gap-1 shrink-0 justify-end" />
              <Show when={windows()}>
...
function TitlebarV2Right(props: { state: TitlebarV2RightState }) {
  return (
    <div class="relative z-20 flex shrink-0 items-center justify-end gap-0 overflow-visible">
      ...
      <div id="mongolgpt-titlebar-right" class="flex shrink-0 items-center justify-end gap-0" />
    </div>
  )
}
