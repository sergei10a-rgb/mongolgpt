...
beforeAll(async () => {
  ...
  mock.module("@mongolgpt/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@mongolgpt/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@mongolgpt/ui/icon", () => ({ Icon: () => null }))
  mock.module("@mongolgpt/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
