...
export function DebugBar() {
  ...
  return (
    <aside
      ...
      class="pointer-events-auto fixed bottom-3 left-1/2 z-50 hidden w-[308px] max-w-[calc(100vw-1.5rem)] -translate-x-1/2 overflow-hidden rounded-xl border border-border-base bg-surface-raised-stronger-non-alpha p-0.5 text-text-strong shadow-[var(--shadow-lg-border-base)] md:block sm:bottom-4 sm:w-[324px]"
    >
