...
const DEFAULT_SERVER_URL_KEY = "mongolgpt.settings.dat:defaultServerUrl"
const LEGACY_DEFAULT_SERVER_URL_KEY = "mongolgpt.settings.dat:defaultServerUrl"
  ...
  Sentry.init({
    ...
    integrations: (integrations) => {
      return integrations.filter(
        (i) => i.name !== "Breadcrumbs" && !(channel === "prod" && i.name === "GlobalHandlers"),
      )
    },
  })
}
