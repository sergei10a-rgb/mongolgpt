import { documentationRepositoryUrl, productSupportUrl, repositoryUrl } from "@mongolgpt/core/product"
...
export const supportUrl = value(import.meta.env.VITE_MONGOLGPT_SUPPORT_URL, productSupportUrl)
