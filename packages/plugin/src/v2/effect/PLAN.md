...
- Effect plugins import `@mongolgpt/plugin/v2/effect`, not `@mongolgpt/core`.
- Public domain values use generated `@mongolgpt/sdk` types.
...
- Define `PluginHost` domain capabilities in `@mongolgpt/plugin/v2/effect`.
