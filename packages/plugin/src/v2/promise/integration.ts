...
export interface IntegrationHooks extends Hooks<{ transform: IntegrationDraft }> {
  readonly connection: {
    readonly active: (integrationID: string) => Promise<import("@mongolgpt/sdk/v2/types").ConnectionInfo | undefined>
    readonly resolve: (
      connection: import("@mongolgpt/sdk/v2/types").ConnectionInfo,
