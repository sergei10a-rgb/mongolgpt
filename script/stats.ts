...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/sergei10a-rgb/mongolgpt/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for sergei10a-rgb/mongolgpt...\n")
...
console.log("Fetching npm all-time downloads for mongolgpt...\n")
const npmDownloads = await fetchNpmDownloads("mongolgpt")
