...
Generates UPCOMING_CHANGELOG.md by running the MongolGPT changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for mongolgpt run (default: low)
      --quiet            Suppress mongolgpt command output unless it fails
