...
const byokCredentialsKeyV1 = process.env.SST_SECRET_ByokCredentialsKeyV1?.trim()
if (!byokCredentialsKeyV1 || byokCredentialsKeyV1.length < 32) {
  throw new Error("SST secret ByokCredentialsKeyV1 must contain at least 32 characters.")
}
