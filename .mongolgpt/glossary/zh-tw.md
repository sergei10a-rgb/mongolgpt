...
- PR #13942: https://github.com/sergei10a-rgb/mongolgpt/pull/13942

## Do Not Translate (Locale Additions)

- `MongolGPT` (preserve casing in prose; keep `mongolgpt` only when it is part of commands, package names, paths, or code)
- `MongolGPT Zen`
- `MongolGPT CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `mongolgpt` in prose when referring to the product name; use `MongolGPT`
