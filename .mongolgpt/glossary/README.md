...
Use this folder for locale-specific translation guidance that supplements `.mongolgpt/agent/translator.md`.
...
- PR #12345: https://github.com/sergei10a-rgb/mongolgpt/pull/12345

## Do Not Translate (Locale Additions)

- `MongolGPT` (preserve casing)
