...
- PR #10809: https://github.com/sergei10a-rgb/mongolgpt/pull/10809
- PR #11496: https://github.com/sergei10a-rgb/mongolgpt/pull/11496

## Do Not Translate (Locale Additions)

- `MongolGPT` (preserve casing in prose; keep `mongolgpt` only in commands, package names, paths, or code)
- `MongolGPT CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
